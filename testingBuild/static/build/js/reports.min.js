...
function fetchRecruiterReports(t){return getRequest(baseUrl+"/recruiter/"+t+"/reports",{},function(t){if(t.status&&"success"==t.status)return pubsub.publish("fetchReportsSuccess",t.data)},function(t,e,s){return pubsub.publish("fetchReportsFail",t)})}
...
function reportList(){var n={},a={};function r(e,t){return"job/"+t+"/applications?status="+e}function i(e){var t,d={element:t=$(n.reportRowClass+".prototype").clone().removeClass("prototype hidden"),publishedOn:t.find(".publishedOn"),jobTitle:t.find(".jobTitle"),postedBy:t.find(".postedBy"),postingViews:t.find(".postingViews"),allCandidates:t.find(".allCandidates"),shortlistedCandidates:t.find(".shortlistedCandidates"),rejectedCandidates:t.find(".rejectedCandidates"),savedCandidates:t.find(".savedCandidates"),resumeViewedCount:t.find(".resumeViewedCount"),resumeDownloadedCount:t.find(".resumeDownloadedCount"),excelDownloadedCount:t.find(".excelDownloadedCount"),recruiterActions:t.find(".recruiterActions"),jobStatus:t.find(".jobStatus"),isJobPremium:t.find(".isJobPremium"),jobCurrentStatus:t.find(".jobCurrentStatus"),recruiterActions:t.find(".recruiterActions")};d.element.attr("data-application-id",e.id),d.publishedOn.text(moment(e.createdAt).format("ll"));var o=e.by.split(" ");return d.jobTitle.text(e.title).attr("href","http://qa200.iimjobs.com/j"+e.url),d.postedBy.text(e.by).attr("href","http://qa200.iimjobs.com/r/"+a.recruiterId+"-"+o[0]+"-"+o[1]),d.postingViews.text(e.views),d.allCandidates.text(e.total).attr("href",r("",e.id)),d.shortlistedCandidates.text(e.shortlisted).attr("href",r("1",e.id)),d.rejectedCandidates.text(e.rejected).attr("href",r("2",e.id)),d.savedCandidates.text(e.save).attr("href",r("3",e.id)),d.resumeViewedCount.text(e.resumeViewed),d.resumeDownloadedCount.text(e.download||0),d.jobCurrentStatus.text(e.status||"N/A"),d.isJobPremium.text(binary[e.premium]),d.excelDownloadedCount.text(binary[e.excelDownload||0]),d.recruiterActions.text(e.totalActivity||0),d}return{init:function(){n.downloadExcelButton=$("#downloadExcel"),n.reportsTable=$("#reportsTable"),n.reportRowClass=".reportRow",n.candidateDownloadResumeButtonClass=".candDownloadResume",n.candidateProfessionalItemClass=".candProfessionalItem",n.candidateEducationItemClass=".candEducationItem",n.candTagItemClass=".candTagItem",n.reportRowShell=$(".reportRo.shell"),n.emptyView=$(".empty-screen"),n.header=$(".head"),n.button=$(".white"),jQuery(".header .menu-list-item.reports").addClass("active"),n.downloadExcelButton.click(function(){var e={event_category:eventMap.downloadReportsClick.cat,event_label:"origin=report,recId="+recruiterId};return sendEvent(eventMap.downloadReportsClick.event,e),!0})},addToList:function(e){var o="";0==e.length&&(n.emptyView.removeClass("hidden"),n.header.addClass("hidden"),n.button.addClass("hidden")),e.forEach(function(e,t){var d=i(e);o+=d.element[0].outerHTML}),n.reportRowShell.addClass("hidden"),n.reportsTable.append(o)},setConfig:function(e,t){a[e]=t},setHref:function(){n.downloadExcelButton.attr("href",baseUrl+"/recruiter/"+a.recruiterId+"/reports-download?token="+getCookie(cookieName))}}}var binary={1:"Yes",0:"No"};
function errorHandler(e){var t=e.responseJSON;return t?503!=e.status?toastNotify(3,t.message):void toastNotify(3,"Oops...something went wrong. Our engineers are fixing the issue"):toastNotify(3,"Looks like you are not connected to the internet")}jQuery(document).ready(function(){var r=reportList();r.init(),r.setConfig("recruiterId",recruiterId),r.setHref(),fetchRecruiterReports(recruiterId);pubsub.subscribe("fetchReportsSuccess",function(e,t){r.addToList(t)}),pubsub.subscribe("fetchReportsFail",function(e,t){errorHandler(t)})});
