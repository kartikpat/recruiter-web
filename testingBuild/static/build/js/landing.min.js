...
$.fn.isInViewport=function(){var e=$(this).offset().top,r=e+$(this).outerHeight(),o=$(window).scrollTop(),i=o+$(window).height();return o<r&&e<i},jQuery(document).ready(function(){1024<=jQuery(window).width()?$(window).on("load scroll",function(){$(".hero-content").each(function(){jQuery(this).hasClass("show")||$(this).isInViewport()&&$(this).addClass("show")})}):(jQuery(".highlight-wrapper .category-item").removeClass("border-bottom border-right"),jQuery(".highlight-wrapper .category-item").each(function(e,r){e%2!=0&&jQuery(r).addClass("no-right-border")}),jQuery(".highlight-wrapper .category-item").eq(-1).addClass("no-bottom-border"),jQuery(".highlight-wrapper .category-item").eq(-2).addClass("no-bottom-border")),$("#loginForm").on("click",".trigger-register-registration-modal",function(){return jQuery("body").addClass("fixed"),jQuery(".recruiter-sign-in-modal").addClass("hidden"),jQuery(".modal-overlay").removeClass("hidden"),jQuery(".recruiter-register-modal").removeClass("hidden"),!1}),jQuery(".trigger-register-sign-in-modal").on("click",function(){jQuery("body").addClass("fixed"),jQuery(".recruiter-register-modal").addClass("hidden"),jQuery(".modal-overlay").removeClass("hidden"),jQuery(".recruiter-sign-in-modal").removeClass("hidden")}),jQuery(".close-modal").on("click",function(){jQuery("body").removeClass("fixed"),jQuery(".modal-content").addClass("hidden"),jQuery(".modal-overlay").addClass("hidden")}),jQuery(".modal-overlay").on("click",function(e){jQuery(e.target).parents(".modal-overlay").length||(jQuery("body").removeClass("fixed"),jQuery(this).addClass("hidden"))})});
...
function submitLogin(e){return postRequest(baseUrl+"/recruiter/login",null,e,function(e,s,o){if(e.status&&"success"==e.status){var n=o.getResponseHeader("Set-Token"),u=o.getResponseHeader("Set-Universal-Token");return Set_Cookie(cookieName,n,1,"/",baseDomainName),Set_Cookie(oldCookieName,u,1,"/",baseDomainName,null,!0),pubsub.publish("successfulLogin",e.data)}},function(e,s,o){return pubsub.publish("failedLogin",e)})}
function submitRegister(e){postRequest(baseUrl+"/recruiter/register",null,e,function(e,s,t){if(e.status&&"success"==e.status){var u=t.getResponseHeader("Set-Token"),i=t.getResponseHeader("Set-Universal-Token");return Set_Cookie(cookieName,u,1,"/",baseDomainName),Set_Cookie(oldCookieName,i,1,"/",baseDomainName,null,!0),pubsub.publish("successfulRegister",e.data)}},function(e,s,t){return pubsub.publish("failedRegister",e)})}
var errorResponsesLogin={missingEmail:"Please enter the Email address",invalidEmail:"That looks like an invalid email address",missingPassword:"Please enter your password",invalidPassword:"Please enter a valid password",userFail:"We could not find an account with that email address.",passwordFail:"That password did not match. We can help you ",missingParameters:"Oops! Our engineers will fix this shortly. Please try again after sometime.",serviceError:"Oops! Our engineers are working on fixing this, please try again after sometime.",noInternet:"Looks like you are not connected to the internet"},emailRegex=/^[a-zA-Z0-9.!#$%&’*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$/;function userCredentials(){var s={};return{init:function(){s.email=$("#email"),s.password=$("#password"),s.login=$("#login"),s.errors=$(".error"),s.loginForm=$("#loginForm"),s.loginForm.find("input").keypress(function(e){13===e.keyCode&&s.login.click()}),s.loginForm.find("input").keyup(function(e){13!==e.keyCode&&$(this).next(".error").text("")})},getData:function(){return{email:s.email.val().trim(),password:s.password.val().trim()}},validateLogin:function(){s.errors.text("");var e=1;return s.email&&s.email.val().trim()||(s.email.next(".error").text(errorResponses.missingEmail),e=0),s.email&&s.email.val().trim()&&!emailRegex.test(s.email.val().trim())&&(s.email.next(".error").text(errorResponses.invalidEmail),e=0),s.password&&s.password.val()||(s.password.next(".error").text(errorResponses.missingPassword),e=0),0!=e},loginHandler:function(e){s.login.click(e)},errorHandler:function(e){var r="";switch(e.status){case 404:r=errorResponsesLogin.userFail;break;case 401:r=errorResponsesLogin.passwordFail;break;case 503:r=errorResponsesLogin.serviceError;break;case 422:r=errorResponsesLogin.missingParameters;break;default:r=errorResponsesLogin.noInternet}return 404==e.status?s.email.next(".error").html(r+"<span class='register-link'> <a href='' style='font-size:11px;' class='link-color trigger-register-registration-modal'>Looking to register?</a></span>"):401==e.status?s.password.next(".error").html(r+"<span class='forgot-pass'><a href='/forgot-password' style='font-size:11px;' class='link-color forgot-recruiter-password'>recover it.</a></span>"):void s.password.next(".error").text(r)},test:function(e){e(s)}}}
var errorResponses={missingName:"Please enter your name",missingEmail:"Please enter email id",invalidEmail:"Please enter a valid email id",missingPhone:"Please enter phone number",invalidPhone:"Please add a valid 10 digit number",missingDesignation:"Please enter the designation",missingOrganization:"Please enter the organisation",missingPassword:"Please enter a password",missingConfirmPassword:"Please confirm your password",passwordMismatch:"The passwords you entered do not match",invalidPassword:"Please enter a valid password",userFail:"Email address does not exist",passwordFail:"Incorrect password",missingParameters:"Oops! Our engineers will fix this shortly. Please try again after sometime.",serviceError:"Oops! Our engineers are working on fixing this, please try again after sometime.",duplicate:"This email is already registered. Please login.",minLengthPassword:"Password should be at least 6 characters",missingRecruiterType:"Please select recruiter type",noInternet:"Looks like you are not connected to the internet"};function registerUser(){var s={};function r(e){e.next(".error").text("")}return{init:function(){s.name=$("#registerName"),s.email=$("#registerWorkEmail"),s.phone=$("#registerPhone"),s.designation=$("#registerDesignation"),s.organization=$("#registerOrganization"),s.password=$("#registerPassword"),s.confirmPassword=$("#registerConfirmPassword"),s.register=$("#register"),s.errors=$(".error"),s.recruiterType=$("#rectype"),s.registerForm=$("#registerForm"),s.registerForm.find("input").keypress(function(e){13===e.keyCode&&s.register.click()}),s.registerForm.find("input").keyup(function(e){13!==e.keyCode&&r($(this))}),s.registerForm.find("select").change(function(e){13!==e.keyCode&&r($(this))})},getData:function(){return{name:s.name.val(),email:s.email.val(),phone:s.phone.val(),designation:s.designation.val(),organisation:s.organization.val(),password:s.password.val(),confirmPassword:s.confirmPassword.val(),type:s.recruiterType.val()}},validateRegister:function(){var e=1;return s.errors.text(""),ifExists(s.name)||(e=0),ifExists(s.email)||(e=0),checkEmail(s.email)||(e=0),ifExists(s.phone)||(e=0),checkPhone(s.phone)||(e=0),ifExists(s.designation)||(e=0),ifExists(s.organization)||(e=0),ifExists(s.password)||(e=0),ifExists(s.confirmPassword)||(e=0),checkMinCharacters(s.password,6)||(e=0),checkPassword(s.password,s.confirmPassword)||(e=0),ifExists(s.recruiterType)||(e=0),0!=e},registerHandler:function(e){s.register.click(e)},errorHandler:function(e){var r="";switch(e.status){case 404:r=errorResponses.userFail;break;case 401:r=errorResponses.passwordFail;break;case 503:r=errorResponses.serviceError;break;case 422:r=errorResponses.missingParameters;break;case 409:r=errorResponses.duplicate;break;default:r=errorResponses.noInternet}if(409==e.status)return s.email.next(".error").text(r);s.recruiterType.next(".error").text(r)},test:function(e){e(s)}}}function checkMinCharacters(e,r){return!e.val().trim()||(!!checkCharacters(e.val().length,r)||(e.next(".error").text(errorResponses["minLength"+e.attr("name")]),!1))}function checkPassword(e,r){return!e.val().trim()||!r.val().trim()||(!!ifBothMatches(e.val(),r.val())||(r.next(".error").text(errorResponses.passwordMismatch),!1))}function checkEmail(e){return!e.val()||(!!(e&&e.val()&&isValidEmail(e.val()))||(e.next(".error").text(errorResponses.invalidEmail),!1))}function checkPhone(e){return!e.val()||(!!(e&&e.val()&&isValidPhone(e.val()))||(e.next(".error").text(errorResponses.invalidPhone),!1))}function ifExists(e,r){var s=r?e.val():e.val().trim();return!(!e||!s)||(e.next(".error").text(errorResponses["missing"+e.attr("name")]),!1)}
$(document).ready(function(){var r=userCredentials();r.init();var d=getQueryParameter("callbackUrl");r.loginHandler(function(e){e.preventDefault(),r.validateLogin()&&(s(),$("#login").prop("disabled",!0),submitLogin(r.getData()))});pubsub.subscribe("successfulLogin",function(e,i){if(s(),!isEmpty(d)){var r=removeParam("callbackUrl",window.location.href);return window.history.replaceState("object or string","Title",r),document.getElementById("login").disabled=!1,window.location=d}window.location=staticEndPoints.dashboard,document.getElementById("login").disabled=!1}),pubsub.subscribe("failedLogin",function(e,i){$("#login").removeClass("hidden"),$(".spinner").addClass("hidden"),r.errorHandler(i),document.getElementById("login").disabled=!1});var n=registerUser();n.init(),n.registerHandler(function(e){n.validateRegister()&&($("#register").prev().removeClass("hidden"),$("#register").addClass("hidden"),document.getElementById("register").disabled=!0,submitRegister(n.getData()))});pubsub.subscribe("successfulRegister",function(e,i){$("#register").prev().removeClass("hidden"),$("#register").addClass("hidden"),window.location="/verify-email",document.getElementById("register").disabled=!1}),pubsub.subscribe("failedRegister",function(e,i){$("#register").prev().addClass("hidden"),$("#register").removeClass("hidden"),n.errorHandler(i),document.getElementById("register").disabled=!1});function s(){$("#login").addClass("hidden"),$(".spinner").removeClass("hidden")}});
