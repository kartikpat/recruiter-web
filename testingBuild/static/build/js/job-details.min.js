...
var jobTagsArray={};function Job(){var j={};return{init:function(){j.jobTitle=$("#jobTitle"),j.jobTags=$("#jobTags"),j.jobDescription=$("#jobDescription"),j.postedBy=$("#postedBy"),j.postedByInfo=$("#postedByInfo"),j.jobCategory=$("#jobCategory"),j.jobCode=$("#jobCode"),j.jobLocation=$("#jobLocation"),j.jobPostedOn=$("#jobPostedOn"),j.jobViews=$("#jobViews"),j.jobApplications=$("#jobApplications")},setData:function(o,e){var t,s;j.jobTitle.text((t=e.title,s=/\(\d+-\d+ \w+\)$/,t.replace(s,""))).removeClass("shell"),j.jobDescription.html(e.description||"No Description Available").removeClass("shell"),j.jobCategory.text(categoryObj[e.category]).removeClass("shell");var a,i,l,n,r=(a=e.location,i=[],a.forEach(function(o,e){for(var t in cityList)if(cityList[t][o]){var s=cityList[t][o];i.push(s)}}),i);if(0<e.otherLocation.length&&r.push(e.otherLocation),1<r.length&&(r=r.join(", ")),j.jobLocation.text(r).removeClass("shell"),e.tags&&e.tags.length){var b=(l=e.tags,n="",l.forEach(function(o,e){n+="#"+o+" "}),n);j.jobTags.html(b).removeClass("shell")}else j.jobTags.addClass("hidden").removeClass("shell");j.postedBy.text(profile.name).removeClass("shell"),j.postedByInfo.text(profile.designation+" at "+profile.organisation),j.jobCode.text(e.publishedId).removeClass("shell"),j.jobPostedOn.text(moment(e.created).format("DD MMMM YYYY")).removeClass("shell"),j.jobViews.text(e.views||"N.A").removeClass("shell"),j.jobApplications.text(e.totalApplications||"N.A").removeClass("shell")}}}
var cityList={Anywhere:{0:"Any Location",87:"Metros",88:"Anywhere in India/Multiple Locations",89:"Overseas/International"},"National Locations":{1:"Delhi NCR",2:"Mumbai",3:"Bangalore",4:"Hyderabad",5:"Kolkata",6:"Chennai",7:"Pune",8:"Gujarat",9:"Maharashtra",10:"MP",11:"Jaipur",12:"Guwahati",13:"Goa",14:"Chandigarh",15:"Punjab",16:"Haryana",17:"Kerala",18:"Orrisa",19:"Bihar",20:"Jharkhand",21:"UP",31:"Karnataka",32:"Tamil Nadu",33:"Rajasthan",34:"Andhra Pradesh",35:"Telangana",36:"Delhi",37:"Gurgaon/Gurugram",38:"Noida",39:"Greater Noida",40:"Faridabad",41:"Ghaziabad",42:"Jammu & Kashmir",43:"Jammu",44:"Srinagar",45:"Amritsar",46:"Jalandhar",47:"Patiala",48:"Ludhiana",49:"Sonipat",50:"Panipat",51:"Udaipur",52:"Jodhpur",53:"Ahmedabad",54:"Surat",55:"Gandhinagar",56:"Vadodara/Baroda",57:"Haridwar",58:"Dehradun",59:"Uttarakhand",60:"Lucknow",61:"Patna",62:"Ranchi",63:"Jamshedpur",64:"Chhattisgarh",65:"Bhubaneshwar",66:"Nagpur",67:"Nasik",68:"Navi Mumbai",69:"Thane",70:"Cochin/Kochi",71:"Hosur",72:"Hubli",73:"Mysore",74:"Raipur",75:"Trivandrum/Thiruvananthapuram",76:"Vijayawada",77:"Guntur",78:"Vishakhapatnam/Vizag",79:"Aurangabad",80:"Rajkot",81:"Varanasi/Banaras",82:"Warangal",83:"Madurai",84:"Coimbatore",85:"Pondicherry",86:"Cuttack"},"International Locations":{22:"US",23:"UK",24:"Singapore",25:"Middle East",26:"Africa",27:"Malaysia",28:"EU",30:"Hong Kong",90:"Bahrain",91:"Dubai",92:"Kabul",93:"Kuwait",94:"Nigeria",95:"London",96:"Oman",97:"Muscat",98:"Doha",99:"Qatar",100:"Abu Dhabi",101:"Saudi Arabia",102:"Riyadh",103:"Indonesia",104:"Nepal",105:"Bhutan",106:"Dhaka",107:"Bangladesh",108:"China",109:"Afghanistan",110:"Pakistan",111:"Sri Lanka",112:"Ethiopia",113:"Egypt",114:"Kenya",115:"Nairobi",116:"Tanzania",117:"South Africa",118:"Zimbabwe",119:"Zambia",120:"Philippines"},Others:{100000:"Others"}},categoryObj={13:"Finance",14:"Sales & Marketing",16:"Consulting",17:"HR",15:"IT & Systems",19:"Operations",21:"Legal",22:"BPO"};
function errorHandler(o){if(401==o.status)return window.location=staticEndPoints.dashboard;var t=o.responseJSON;return t?503!=o.status?toastNotify(3,t.message):void toastNotify(3,"Oops...something went wrong. Our engineers are fixing the issue"):toastNotify(3,"Looks like you are not connected to the internet")}$(document).ready(function(){var e=Job();e.init(),jobId&&fetchJob(jobId,recruiterId);pubsub.subscribe("fetchedJob:"+jobId,function(o,t){console.log(t[0]),e.setData(jobId,t[0])}),pubsub.subscribe("failedToFetchJob:"+jobId,function(o,t){errorHandler(t)})});
