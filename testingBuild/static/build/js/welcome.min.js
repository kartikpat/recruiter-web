...
function resendActivationLink(s){postRequest(baseUrl+"/recruiter/resend",null,{},function(s,e,u){if(s.status&&"success"==s.status)return pubsub.publish("resendInviteSuccess",s)},function(s,e,u){return pubsub.publish("resendInviteFail",s)})}
function userResend(){var t={};return{init:function(){t.resendActive=$(".resendActive"),t.secText=$(".secText"),t.thirdText=$(".thirdText")},submitHandler:function(e){t.resendActive.click(e)},changeText:function(){$(".user-email-sent").removeClass("hidden"),t.secText.text("We've again sent you an email on"),t.thirdText.text("If you still did not receive any email, check your spam folder or write to us at hello@iimjobs.com")}}}
function errorHandler(e){var n=e.responseJSON;return n?503!=e.status?toastNotify(3,n.message):void toastNotify(3,"Oops...something went wrong. Our engineers are fixing the issue"):toastNotify(3,"Looks like you are not connected to the internet")}$(document).ready(function(){var t=userResend();t.init(),t.submitHandler(function(e){e.preventDefault(),resendActivationLink(token)});pubsub.subscribe("resendInviteSuccess",function(e,n){t.changeText()}),pubsub.subscribe("resendInviteFail",function(e,n){errorHandler(n)})});
