...
function Chat(){var d={},n={};function i(e){var t,n,a=(t=e.userId,(n=$(".conversationItem.prototype").clone().removeClass("prototype hidden")).attr("data-candidate-id",t),{element:n,image:n.find(".userImg"),name:n.find(".userName"),designation:n.find(".userDesignation"),candStatus:n.find(".candStatus")});return a.image.attr("src",e.img||"/static/images/noimage.png"),a.name.text(e.name),a.designation.text(e.designation),a.element.attr("data-channel-name",e.channel),a}function c(e,t){var n,a=$(".message.sent.prototype").clone().removeClass("prototype hidden").attr("id",e.entry.id);return n=moment(e.entry.time).format("DD MMMM YYYY")+" , ",n+=moment(e.entry.time).format("hh:mm a"),a.find(".msgContent").html(e.entry.msg).attr("title",n),1==t&&a.find(".msgContent").append("<span class='icon-chatContainer'><i class='icon-clock-1'></i></span>"),a}function m(e,t){var n,a=$(".message.received.prototype").clone().removeClass("prototype hidden");return 1==t&&a.find(".useImg").attr("src",e.entry.img||"/static/images/noimage.png").removeClass("invisible"),n=moment(e.entry.time).format("DD MMMM YYYY")+" , ",n+=moment(e.entry.time).format("hh:mm a"),a.find(".msgContent").html(e.entry.msg).attr("title",n),a}function r(){$(".current-chat").scrollTop(jQuery("#mssgContainer").outerHeight())}return{init:function(){d.isActive=$("#isActive"),d.isOnline=$("#isOnline"),d.recruiterName=$(".recruiterName"),d.userName=$(".userName"),d.searchCandidate=$("#searchCandidate"),d.conversationItemList=$("#conversationItemList"),d.msgContent=$("#msgContent"),d.sendMsg=$("#sendMsg"),d.userImg=$(".userImg"),d.userOrg=$(".userOrg"),d.userDes=$(".userDes"),d.userPhone=$(".userPhone"),d.userLoc=$(".userLoc"),d.userExp=$(".userExp"),d.conversationItemClass=".conversationItem",d.mssgContainer=$("#mssgContainer"),d.recruiterFullName="",d.channelName="",d.candidateId=null,d.welcomeContainer=$(".welcomeContainer"),d.chatWindow=$(".chatWindow"),d.userProfile=$(".userProfile"),d.conversationList=$(".conversationList"),d.backButtonChat=$(".backButtonChat"),d.uuid="",d.index=-1,d.candImage=$(".candImage"),d.statePendingClass=".icon-chatContainer i",d.stateErrorClass=".error-container",d.noMessages=$(".noMessages"),d.spinner=$(".chat-spinner"),d.backButtonChat.click(function(){d.channelName="",d.backButtonChat.addClass("hidden"),d.candImage.addClass("hidden"),d.chatWindow.addClass("hidden"),d.userImg.attr("src","/static/images/noimage.png"),d.userName.text("Your Chats!"),d.conversationList.removeClass("hidden")})},setConfig:function(e,t){n[e]=t},addToList:function(e){var a="";if($(".loading.loaderScroller.first").addClass("hidden"),!e.length&&1!=e.index)return d.welcomeContainer.addClass("hidden"),void $(".empty-screen.no-list").removeClass("hidden");e.forEach(function(e,t){var n=i(e);a+=n.element[0].outerHTML,a+='<div class="conversation-item-separator"></div>'}),d.conversationItemList.html(a),d.conversationItemList.closest(".conversations-list").removeClass("hidden")},onClickSingleChatItem:function(n){d.conversationItemList.on("click",d.conversationItemClass,function(){$(d.conversationItemClass).removeClass("conversation-item-active"),$(this).addClass("conversation-item-active");var e=$(this).attr("data-channel-name");if($(this).find(".newMsgNotify").attr("data-count","0").addClass("hidden"),d.channelName!=e){var t=$(this).attr("data-candidate-id");if(d.msgContent.attr("data-channel-name",e),d.candidateId=t,d.channelName=e,$(window).outerWidth()<769)return n(t);d.welcomeContainer.addClass("hidden"),d.mssgContainer.empty(),n(t)}})},setCandidateProfile:function(e){d.userImg.attr("src",e.img||"/static/images/noimage.png"),d.userName.text(e.name),d.userName.attr("href","/candidate/"+e.userId+"/profile"),d.userPhone.text(e.phone),d.userDes.text(e.designation),d.userOrg.text(e.organization),d.userLoc.text(e.location),e.exp&&d.userExp.text(e.exp.year+"y "+e.exp.month+"m")},populateMessages:function(s,e){var o="",r=1;console.log(s),s.forEach(function(e,t){if(0==t||0<t&&moment(s[t-1].entry.time).format("DD MM YYYY")!=moment(e.entry.time).format("DD MM YYYY")){var n=(a=e,i=$(".timeSeperator.prototype").clone().removeClass("prototype hidden"),moment(a.entry.time).format("DD MM YYYY")==moment().format("DD MM YYYY")?i.text("Today"):i.text(moment(a.entry.time).format("DD MMMM YYYY")),i);o+=n[0].outerHTML}var a,i;e.entry.UUID==d.uuid?(n=c(e),r=1,o+=n[0].outerHTML):(n=m(e,r),o+=n[r=0].outerHTML)}),d.mssgContainer.prepend(o),$(window).outerWidth()<769&&(d.backButtonChat.removeClass("hidden"),d.candImage.removeClass("hidden"),d.conversationList.addClass("hidden")),$(".loading.loaderScroller.second").addClass("hidden"),d.chatWindow.removeClass("hidden"),d.userProfile.removeClass("hidden"),l()},onSendMessage:function(a){d.sendMsg.click(function(){var e={event_category:eventMap.sendMsg.cat,event_label:"origin=MyChats,recId="+recruiterId};sendEvent(eventMap.sendMsg.event,e);var t=d.msgContent.val().trim();if(""==t)return d.msgContent.val("");a(t,d.channelName,d.candidateId)}),d.msgContent.keypress(function(e){var t={event_category:eventMap.sendMsg.cat,event_label:"origin=MyChats,recId="+recruiterId};if(sendEvent(eventMap.sendMsg.event,t),13==e.which&&!e.shiftKey){var n=$(this).val().trim();return""==n?$(this).val(""):(a(n,d.channelName,d.candidateId),13!==e.which)}})},receiveMessage:function(e,t){if(d.channelName==t){var n={entry:{}};n.entry.msg=e.msg,n.entry.time=e.time,n.entry.img=e.img;var a=m(n);return d.mssgContainer.append(a),l(),void r()}var i,s,o;i=t,s=d.conversationItemList.find(".conversationItem[data-channel-name="+i+"] .newMsgNotify"),o=s.attr("data-count"),o=parseInt(o)+1,s.attr("data-count",o),s.text(o).removeClass("hidden")},showStatusIcon:function(e){$(".conversationItem[data-channel-name="+e+"]").find(".candStatus").removeClass("hidden")},hideStatusIcon:function(e){$(".conversationItem[data-channel-name="+e+"]").find(".candStatus").addClass("hidden")},onInputSearchCandidate:function(t){d.searchCandidate.on("input",function(){var e=$(this).val();e=e.toLowerCase(),t(e)})},appendSendMessage:function(e,t,n,a,i){var s={entry:{}};s.entry.msg=e,s.entry.time=n||Date.now(),s.entry.img=t,s.entry.id=a;var o=c(s,i);d.mssgContainer.append(o),l(),r(),d.msgContent.val("")},setUuid:function(e){d.uuid=e},scrollToBottom:r,setRecruiterActive:function(){d.isOnline.removeClass("not-active"),d.isActive.text("Active Now")},setRecruiterInactive:function(){d.isOnline.addClass("not-active"),d.isActive.text("Not Active")},setChat:function(e,t){d.msgContent.attr("data-channel-name",e),d.candidateId=t,d.channelName=e},hideCandidateBlocks:function(){d.chatWindow.addClass("hidden"),d.userProfile.addClass("hidden")},setDeliveredState:function(e){e&&$("#"+e).find(d.statePendingClass).removeClass("icon-clock-1").addClass("icon-tick")},setFailedState:function(e){e&&$("#"+e).find(d.stateErrorClass).removeClass("hidden")},hideSpinner:function(){d.spinner.addClass("hidden")},showSpinner:function(){d.spinner.removeClass("hidden")}};function l(){window.innerWidth<=768?$(".chat-body").find(".tooltip").not(".prototype .tooltip").tooltipster({animation:"fade",delay:0,side:["bottom"],theme:"tooltipster-borderless",trigger:"click"}):$(".chat-body").find(".tooltip").not(".prototype .tooltip").tooltipster({animation:"fade",delay:0,side:["bottom"],theme:"tooltipster-borderless"})}}
var channelsArray=[];function getDeviceId(e){e||(e=20);for(var a="",t="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",r=0;r<e;r++)a+=t.charAt(Math.floor(Math.random()*t.length));return"web"+a+Date.now()}function getArray(e){var a=[];return e.forEach(function(e){a.push(e.channel)}),a}function errorHandler(e){var a=e.responseJSON;return a?503!=e.status?toastNotify(3,a.message):void toastNotify(3,"Oops...something went wrong. Our engineers are fixing the issue"):toastNotify(3,"Looks like you are not connected to the internet")}globalParameters={channelName:"",messageNumber:10,startTimeToken:null,endTimeToken:null,clicked:1,startChatConversation:1},jQuery(document).ready(function(){var o=getDeviceId(),i=ChatEngine(recruiterId,profile.email);i.initialize(),i.addListeners(function(e){e.actualChannel;var a=e.channel,t=e.message;e.publisher,e.subscribedChannel,e.subscription,e.timetoken;if(t.deviceId==o)return void s.setDeliveredState(t.messageId);t.UUID==btoa(recruiterId+"--"+profile.email)?s.appendSendMessage(t.msg,t.img,t.t):s.receiveMessage(t,a)},function(e){e.action,e.channel,e.subscription,e.timestamp,e.status,e.message,e.service,e.uuids,e.occupancy;"join"==e.action&&2<=e.occupancy&&e.uuid!=(uuid||i.getUUID())?s.showStatusIcon(e.channel):"leave"==e.action&&e.occupancy<2&&e.uuid!=(uuid||i.getUUID())&&s.hideStatusIcon(e.channel)},function(e){e.category,e.operation,e.affectedChannels,e.subscribedChannels,e.affectedChannelGroups,e.lastTimetoken,e.currentTimetoken;if("PNNetworkDownCategory"==e.category)return s.setRecruiterInactive(e);if("PNNetworkUpCategory"==e.category)return s.setRecruiterActive(e)});var s=Chat(),r=Store();s.init(),fetchRecruiterChats(recruiterId),s.onClickSingleChatItem(function(e){s.hideCandidateBlocks(),$(".loading.loaderScroller.second").removeClass("hidden");var t=r.getCandidateFromStore(e);globalParameters.channelName=t.channel,globalParameters.clicked=1,i.fetchHistory(t.channel,globalParameters.messageNumber,null,null,function(e,a){c(e,a,t)})});var n=getQueryParameter("candidateId");s.setUuid(btoa(recruiterId+"--"+profile.email)),s.onSendMessage(function(e,a,t){var r=Date.now(),n=getDeviceId(10);s.appendSendMessage(e,profile.pic,r,n,1),i.publish({UUID:uuid||btoa(recruiterId+"--"+profile.email),deviceId:o,time:r,usr:recruiterId,name:profile.name,tt:1,msg:e,img:profile.pic,type:1,messageId:n},a,function(e,a){if(200==e.statusCode);else if("PNNetworkIssuesCategory"==e.category){var t={};console.log(n),s.setFailedState(n),t.message="Looks like you are not connected to the internet",toastNotify(3,t.message)}}),submitChatMessage({channel:a,senderName:profile.name,senderOrganization:profile.organisation,timestamp:Date.now(),text:e})});var e;pubsub.subscribe("fetchedRecruiterChats",function(e,a){if(s.addToList(a),channelsArray=a,r.saveToStore(a),i.subscribe(getArray(channelsArray)),!isEmpty(n)){var t=r.getCandidateFromStore(n);globalParameters.channelName=t.channel,i.fetchHistory(t.channel,globalParameters.messageNumber,null,null,c),s.setCandidateProfile(t),s.setChat(t.channel,n)}}),pubsub.subscribe("fetchedRecruiterChatsFail",function(e,a){errorHandler(a)});function c(e,a,t){s.hideSpinner(),globalParameters.startTimeToken=parseInt(a.startTimeToken),s.populateMessages(a.messages,globalParameters.startChatConversation),s.setCandidateProfile(t),1==globalParameters.clicked&&(s.scrollToBottom(),globalParameters.clicked=0)}function a(){if($(".current-chat").scrollTop()<5){if(0==globalParameters.startTimeToken)return;s.showSpinner(),globalParameters.startChatConversation=0,i.fetchHistory(globalParameters.channelName,globalParameters.messageNumber,globalParameters.startTimeToken,null,c)}}s.onInputSearchCandidate(function(e){var a=[];a.index=1;for(var t=channelsArray,r=0;r<t.length;r++)t[r].name&&-1<t[r].name.toLowerCase().indexOf(e)&&a.push(t[r]);s.addToList(a)}),$(".current-chat").scroll(function(){clearTimeout(e),e=setTimeout(a,100)})});
function Store(){var n={};return{saveToStore:function(t){t.forEach(function(t){n[t.userId]=t})},emptyStore:function(){n={}},getCandidateFromStore:function(t){return n[t]}}}
