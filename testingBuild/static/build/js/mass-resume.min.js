...
function fetchRecruiterResume(u){getRequest(baseUrl+"/recruiter/"+u+"/bulk-downloads",{},function(u){if(u.status&&"success"==u.status)return pubsub.publish("fetchResumeSuccess",u)},function(u,e,s){return pubsub.publish("fetchResumeFail",u)})}
...
function MassResume(){var t={};function s(){var e=t.tableRow.clone().removeClass("prototype hidden");return{element:e,requestId:e.find(".request-id"),date:e.find(".date"),Status:e.find(".status"),count:e.find(".resumes"),downloadLink:e.find(".download-link"),noOfDownloads:e.find(".downloaded")}}function o(e){var t,n=s(),o=e.id,a=btoa(o);n.date.text(ISODateToD_M_Y(e.date)),n.requestId.text(a),n.Status.text(e.status),t=0==e.downloadCount?"No Downloaded":"No. Of Downloads: "+e.downloadCount,n.noOfDownloads.text(t),n.count.text(e.resumeCount);var d=baseUrl+"/bulk/"+o+"/"+e.path;return n.downloadLink.html("<div>Expires On: "+ISODateToD_M_Y(e.expiry)+"  "+ISODateToTime(e.expiry)+"</div><div class='download-link'><a href="+d+">Click Here</a> to download</div>"),n}function a(){t.massResumeShell.addClass("hidden")}return{init:function(){t.tableRow=$(".row.prototype"),t.date=".date",t.resumeContent=$(".mass-resume-content"),t.massResumeShell=$(".massResume.shell"),t.emptyView=$(".empty-view"),t.header=$(".mass-resume-header")},populateResumeStatus:o,getElement:s,showShells:function(){t.massResumeShell.removeClass("hidden")},hideShells:a,addToList:function(e){console.log(e);var n="";0==e.data.length&&(t.emptyView.removeClass("hidden"),t.header.addClass("hidden")),e.data.forEach(function(e){var t=o(e);n+=t.element[0].outerHTML}),a(),$(".mass-resume-content").append(n)}}}function checkTime(e){return e<10&&(e="0"+e),e}function ISODateToTime(e){var t=new Date(e),n=t.getHours(),o=t.getMinutes();return n+":"+(o=checkTime(o))}function ISODateToD_M_Y(e){var t=new Date(e),n=t.getFullYear(),o=t.getMonth(),a=t.getDate();return a<10&&(a="0"+a),o<10&&(o="0"+o),a+"-"+o+"-"+n}
var globalParameters={pageContent:10,pageNumber:1};$(document).ready(function(){var r=MassResume();r.init();var e={};e.pageNumber=globalParameters.pageNumber,e.pageContent=globalParameters.pageContent,fetchRecruiterResume(recruiterId);pubsub.subscribe("fetchResumeSuccess",function(e,a){console.log(a),r.addToList(a)}),pubsub.subscribe("fetchResumeFail",function(e){console.log(e)})});
