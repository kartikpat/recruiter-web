...
function globalSearch(e,u){getRequest(baseUrl+"/recruiter/"+e+"/search",u,function(e){if(e.status&&"success"==e.status)return pubsub.publish("fetchedSearch",e)},function(e,u,s){return pubsub.publish("fetchedFailSearch",e)})}
...
function candidateList(){var r={},n={};function a(e){var t,n,i=(t=e.userID,(n=$(r.candidateItemClass+".prototype").clone().removeClass("prototype hidden")).attr("data-candidate-id",t),{element:n,image:n.find(".candImage"),isOnline:n.find(".candStatus"),name:n.find(".candName"),experience:n.find(".candExperience"),location:n.find(".candCurrentLocation"),appliedOn:n.find(".candAppliedOn"),notice:n.find(".candNotice"),candTagList:n.find(".candTagListing"),eduList:n.find(".candEducationList"),profList:n.find(".candProfessionalList"),isProMember:n.find(".isProMember"),isFollowedUp:n.find(".isFollowedUp"),downloadResumeButton:n.find(r.candidateDownloadResumeButtonClass),candJobList:n.find(".jobListing"),multipleCandJobListContainer:n.find(".multipleJobListingContainer"),multipleJobListingText:n.find(".multipleJobListingText"),multipleCandJobListing:n.find(".multipleJobListing"),jobTitle:n.find(".jobTitle"),candidateViewProfileLink:n.find(".candidateViewProfile")});i.element.attr("data-application-id",e.id),i.image.attr("src",e.img||"/static/images/noimage.png"),i.name.text(e.name||"NA"),i.experience.text(e.exp.year+"y "+e.exp.month+"m"||"NA"),i.location.text(e.currentLocation||"NA"),i.appliedOn.text(moment(e.timestamp,"x").format("DD-MM-YYYY")),7==e.notice?i.notice.text("Immediately Available"):1==e.notice?i.notice.text(e.notice+" month"):i.notice.text(e.notice+" months"),i.downloadResumeButton.attr("href",e.resume),i.downloadResumeButton.attr("download",e.name.replace(/ +/g,"_")+"_resume.pdf");var a="";$.each(e.tags,function(e,t){var n=$(r.candTagItemClass+".prototype").clone().removeClass("prototype hidden");n.find("a").text(t.name).attr("href","/recruiter/tagged-candidates?queryTag="+t.id),a+=n[0].outerHTML}),i.candTagList.html(a);var c="";$.each(e.jobs,function(e,t){if(!(2<e)){var n,i={element:n=$(r.candidateProfessionalItemClass+".prototype").clone().removeClass("prototype hidden"),name:n.find(".companyName"),tenure:n.find(".candTenure"),designation:n.find(".candDesignation")};i.name.text(t.organization),i.designation.text(t.designation);var a=getMonthName(t.exp.from.month),o=getMonthName(t.exp.to.month),d=t.exp.from.year,s=t.exp.from.year,l=t.is_current?a+" , "+d+" to Present":a+" , "+d+" to "+o+" , "+s;i.tenure.text(l),c+=i.element[0].outerHTML}}),i.profList.html(c);var o="";if($.each(e.education,function(e,t){if(!(2<e)){var n,i={element:n=$(r.candidateEducationItemClass+".prototype").clone().removeClass("prototype hidden"),name:n.find(".instituteName"),batch:n.find(".candBatch"),degree:n.find(".candDegree")};i.name.text(t.institute),i.batch.text(t.batch.from+" - "+t.batch.to),i.degree.text(t.degree+" ("+t.courseType+")"),o+=i.element[0].outerHTML}}),i.eduList.html(o),e.applications)if(1<e.applications.length){i.candJobList.addClass("hidden"),i.multipleJobListingText.text("Applied to "+e.applications.length+" jobs");var d="";$.each(e.applications,function(e,t){console.log(t);var n=$(r.candAppliedJobsClass+".prototype").clone().removeClass("prototype hidden");n.html(t.title+" -<a class='candApplyPage' href='/job/"+t.jobID+"/applications/"+t.id+"'>View Profile</a> "),d+=n[0].outerHTML}),i.multipleCandJobListing.append(d),i.multipleCandJobListContainer.removeClass("hidden")}else 1==e.applications.length&&(i.jobTitle.text(e.applications[0].title),i.candidateViewProfileLink.attr("href","/job/"+e.applications[0].jobID+"/applications/"+e.applications[0].id));return e.pro&&i.isProMember.removeClass("hidden"),e.follow&&i.isFollowedUp.removeClass("hidden"),i}function e(){r.candidateListing.empty()}return{init:function(){r.candidateListing=$("#candidateListing"),r.filterByTagList=$("#filterByTagList"),r.candidateItemClass=".candidateItem",r.candidateDownloadResumeButtonClass=".candDownloadResume",r.candidateProfessionalItemClass=".candProfessionalItem",r.candidateEducationItemClass=".candEducationItem",r.candTagItemClass=".candTagItem",r.tagOptionClass=".tagOption",r.tagId=-1,r.candidateItemShell=$(".candidateItem.shell"),r.resultCount=$("#resultCount"),r.queryParam=$("#queryParam"),r.candAppliedJobsClass=".candAppliedJobs",r.multipleJobListingClass=".multipleJobListing",r.multipleJobListingTextClass=".multipleJobListingbox",r.emptyScreen=$(".empty-screen"),r.candidateListing.on("click",r.multipleJobListingTextClass,function(){$(this).siblings(".multipleJobListing").slideToggle()}),r.candidateListing.on("click",".candApplyPage",function(){var e={event_category:eventMap.viewCandidProfile.cat,event_label:"origin=TaggedList,type=GlobalSearch,recId="+recruiterId};sendEvent(eventMap.viewCandidProfile.event,e)})},addToList:function(e,t,n){r.candidateItemShell.addClass("hidden"),console.log(n),console.log(t);var i="";if(e.forEach(function(e,t){var n=a(e);i+=n.element[0].outerHTML}),r.candidateListing.append(i),e.length<n&&0==r.candidateListing.find(".no-more-records").length)return r.candidateListing.append("<div class='no-more-records no-data'>You have reached the end of the list</div>")},setConfig:function(e,t){n[e]=t},emptyCandidateList:e,setHeader:function(e,t){r.resultCount.text(e),r.queryParam.text(decodeURI(t)),0==e&&r.emptyScreen.removeClass("hidden")},showShell:function(){r.candidateItemShell.removeClass("hidden")},emptyCandidateList:e}}
var globalParameters={pageContent:10,pageNumber:1,offset:0,candidateListLength:null};function errorHandler(e){var a=e.responseJSON;return a?503!=e.status?toastNotify(3,a.message):void toastNotify(3,"Oops...something went wrong. Our engineers are fixing the issue"):toastNotify(3,"Looks like you are not connected to the internet")}jQuery(document).ready(function(){var t=candidateList();t.init();chatModelIndex();var r=getQueryParameter("searchQuery"),e={};e.pageNumber=globalParameters.pageNumber,e.pageContent=globalParameters.pageContent,""!=r&&(e.searchString=r),globalSearch(recruiterId,e);var a;pubsub.subscribe("fetchedSearch",function(e,a){hideLoader(),0!=a.data.length?(globalParameters.candidateListLength=a.data.length,t.addToList(a.data,globalParameters.offset,globalParameters.pageContent),t.setHeader(a.stats.total,r)):t.setHeader(0,r)}),pubsub.subscribe("fetchedFailSearch",function(e,a){errorHandler(a)});function o(){if($(window).scrollTop()+$(window).height()>$(document).height()-600&&(globalParameters.pageNumber=globalParameters.pageNumber+1,1!=globalParameters.pageNumber&&globalParameters.candidateListLength==globalParameters.pageContent)){var e={};e.pageNumber=globalParameters.pageNumber,e.pageContent=globalParameters.pageContent,""!=r&&(e.searchString=r),showLoader(),globalSearch(recruiterId,e)}}$(window).scroll(function(){clearTimeout(a),a=setTimeout(o,100)})});
