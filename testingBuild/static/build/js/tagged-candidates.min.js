...
function fetchCandidatesByTags(s,e){return getRequest(baseUrl+"/recruiter/"+e+"/tagged-candidates",s,function(e){if(e.status&&"success"==e.status)return e.obj={},e.obj.pageNumber=s.pageNumber,pubsub.publish("fetchCandidatesByTagsSuccess",e)},function(e,s,t){return pubsub.publish("fetchCandidatesByTagsFail",e)})}
function fetchRecruiterTags(s,t){getRequest(baseUrl+"/recruiter/"+s+"/tags",t,function(s){if(s.status&&"success"==s.status)return pubsub.publish("fetchedTags",s)},function(s,t,u){return pubsub.publish("fetchTagsFail",s)})}
...
function candidateList(){var c={},i={};function d(e){var t,i,a=(t=e.userID,(i=$(c.candidateItemClass+".prototype").clone().removeClass("prototype hidden")).attr("data-candidate-id",t),{element:i,image:i.find(".candImage"),isOnline:i.find(".candStatus"),name:i.find(".candName"),experience:i.find(".candExperience"),location:i.find(".candCurrentLocation"),appliedOn:i.find(".candAppliedOn"),notice:i.find(".candNotice"),candTagList:i.find(".candTagListing"),eduList:i.find(".candEducationList"),profList:i.find(".candProfessionalList"),isProMember:i.find(".isProMember"),isFollowedUp:i.find(".isFollowedUp"),downloadResumeButton:i.find(c.candidateDownloadResumeButtonClass),candJobList:i.find(".jobListing"),multipleCandJobListContainer:i.find(".multipleJobListingContainer"),multipleJobListingText:i.find(".multipleJobListingText"),multipleCandJobListing:i.find(".multipleJobListing"),jobTitle:i.find(".jobTitle"),candidateViewProfileLink:i.find(".candidateViewProfile")});a.element.attr("data-application-id",e.id),a.image.attr("src",e.img||"/static/images/noimage.png"),a.name.text(e.name||"NA"),a.experience.text(e.exp.year+"y "+e.exp.month+"m"||"NA"),a.location.text(e.currentLocation||"NA"),a.appliedOn.text(moment(e.timestamp,"x").format("DD-MM-YYYY")),7==e.notice?a.notice.text("Immediately Available"):1==e.notice?a.notice.text(e.notice+" month"):a.notice.text(e.notice+" months"),a.downloadResumeButton.attr("href",baseUrl+e.resume),a.downloadResumeButton.attr("download",e.name.replace(/ +/g,"_")+"_resume.pdf");var n="";$.each(e.tags,function(e,t){var i=$(c.candTagItemClass+".prototype").clone().removeClass("prototype hidden");i.find("a").text(t.name).attr("href","/candidates/tagged?queryTag="+t.id),n+=i[0].outerHTML}),a.candTagList.html(n);var r="";e.jobs=sortArrayOfObjectsByMultipleKey(e.jobs),$.each(e.jobs,function(e,t){if(!(2<e)){var i,a={element:i=$(c.candidateProfessionalItemClass+".prototype").clone().removeClass("prototype hidden"),name:i.find(".companyName"),tenure:i.find(".candTenure"),designation:i.find(".candDesignation")};a.name.text(t.organization),a.designation.text(t.designation);var n=getMonthName(t.exp.from.month),d=getMonthName(t.exp.to.month),o=t.exp.from.year,s=t.exp.to.year,l=t.is_current?n+", "+o+" to Present":n+", "+o+" to "+d+" , "+s;a.tenure.text(l),r+=a.element[0].outerHTML}}),a.profList.html(r);var d="";if($.each(e.education,function(e,t){if(!(2<e)){var i,a={element:i=$(c.candidateEducationItemClass+".prototype").clone().removeClass("prototype hidden"),name:i.find(".instituteName"),batch:i.find(".candBatch"),degree:i.find(".candDegree")};a.name.text(t.institute),a.batch.text(t.batch.from+" - "+t.batch.to),a.degree.text(t.degree+" ("+t.courseType+")"),d+=a.element[0].outerHTML}}),a.eduList.html(d),e.applications)if(1<e.applications.length){a.candJobList.addClass("hidden"),a.multipleJobListingText.text("Applied to "+e.applications.length+" jobs");var o="";$.each(e.applications,function(e,t){console.log(t);var i=$(c.candAppliedJobsClass+".prototype").clone().removeClass("prototype hidden");i.html(t.title+" -<a class='candApplyPage link-color' href='/job/"+t.jobID+"/applications/"+t.id+"'> View Profile</a> "),console.log(i),o+=i[0].outerHTML}),a.multipleCandJobListing.append(o),a.multipleCandJobListContainer.removeClass("hidden")}else 1==e.applications.length&&(a.jobTitle.text(e.applications[0].title),a.candidateViewProfileLink.attr("href","/job/"+e.applications[0].jobID+"/applications/"+e.applications[0].id));return e.pro&&a.isProMember.removeClass("hidden"),e.follow&&a.isFollowedUp.removeClass("hidden"),a}function e(){c.candidateListing.empty()}return{init:function(){c.candidateListing=$("#candidateListing"),c.filterByTagList=$("#filterByTagList"),c.candidateItemClass=".candidateItem",c.candidateDownloadResumeButtonClass=".candDownloadResume",c.candidateProfessionalItemClass=".candProfessionalItem",c.candidateEducationItemClass=".candEducationItem",c.candAppliedJobsClass=".candAppliedJobs",c.candTagItemClass=".candTagItem",c.tagOptionClass=".tagOption",c.tagId=-1,c.candidateItemShell=$(".candidateItem.shell"),c.candAppliedJobsClass=".candAppliedJobs",c.multipleJobListingClass=".multipleJobListing",c.multipleJobListingTextClass=".multipleJobListingbox",c.emptyView=$(".empty-screen"),c.heading=$(".heading"),c.candidateListing.on("click",c.multipleJobListingTextClass,function(){$(this).siblings(".multipleJobListing").slideToggle()}),jQuery(".header .menu-list-item.my-jobs").addClass("active"),c.candidateListing.on("click",".candApplyPage",function(){var e={event_category:eventMap.viewCandidProfile.cat,event_label:"origin=CandidateApplyList,type=TaggedList,recId="+recruiterId};sendEvent(eventMap.viewCandidProfile.event,e)})},addToList:function(e,t,i){c.candidateItemShell.addClass("hidden");var a=c.filterByTagList.val();if(e.length<1&&1==t)return-1==a?(c.filterByTagList.addClass("hidden"),c.emptyView.removeClass("hidden"),void c.heading.removeClass("hidden")):($(".user-text").text("No tagged candidates for a particular tag"),$(".empty-text").text("There are no candidates for the selected tag"),void c.emptyView.removeClass("hidden"));c.emptyView.addClass("hidden");var n="";return e.forEach(function(e,t){var i=d(e);n+=i.element[0].outerHTML}),c.candidateListing.append(n),e.length<i?c.candidateListing.append("<div class='no-data'>You have reached the end of the list</div>"):void 0},setConfig:function(e,t){i[e]=t},emptyCandidateList:e,onFilterByTag:function(t){c.filterByTagList.change(function(){var e=$(this).val();return c.tagId=e,t(e)})},populateTagsDropdown:function(e){var a="";e.forEach(function(e,t){var i={element:$(c.tagOptionClass+".prototype").clone().removeClass("prototype hidden")};i.element.text(e.name),i.element.val(e.id),a+=i.element[0].outerHTML}),c.filterByTagList.append(a),console.log(c.tagId),c.tagId&&c.filterByTagList.val(c.tagId)},setTagId:function(e){c.tagId=e},getAppliedFilters:function(){var e={};return e.tagId=c.tagId,e},showShell:function(){c.candidateItemShell.removeClass("hidden")},emptyCandidateList:e}}
var globalParameters={pageContent:10,pageNumber:1,tagId:-1,candidateListLength:null};function errorHandler(e){var a=e.responseJSON;return a?503!=e.status?toastNotify(3,a.message):void toastNotify(3,"Oops...something went wrong. Our engineers are fixing the issue"):toastNotify(3,"Looks like you are not connected to the internet")}jQuery(document).ready(function(){var r=candidateList();r.init();var e=getQueryParameter("queryTag");chatModelIndex();isEmpty(e)||(globalParameters.tagId=e,r.setTagId(e));var a={};a.pageNumber=globalParameters.pageNumber,a.pageContent=globalParameters.pageContent,-1!=globalParameters.tagId&&(a.tagId=globalParameters.tagId),fetchRecruiterTags(recruiterId),fetchCandidatesByTags(a,recruiterId),r.onFilterByTag(function(){var e={event_category:eventMap.filterTagged.cat,event_label:"origin=TaggedList,recId="+recruiterId};sendEvent(eventMap.filterTagged.event,e);var a=r.getAppliedFilters(),t={};globalParameters.pageNumber=1,t.pageNumber=globalParameters.pageNumber,t.pageContent=globalParameters.pageContent,-1!=parseInt(a.tagId)&&(t.tagId=a.tagId),r.emptyCandidateList(),r.showShell(),fetchCandidatesByTags(t,recruiterId)});var t;pubsub.subscribe("fetchCandidatesByTagsSuccess",function(e,a){hideLoader(),globalParameters.candidateListLength=a.data.length,r.addToList(a.data,globalParameters.pageNumber,globalParameters.pageContent)}),pubsub.subscribe("fetchCandidatesByTagsFail",function(e,a){errorHandler(a)}),pubsub.subscribe("fetchedTags",function(e,a){var t=sortArrayOfObjectsByKey(a.data,"name");r.populateTagsDropdown(t)}),pubsub.subscribe("fetchTagsFail",function(e,a){errorHandler(a)});function n(){if($(window).scrollTop()+$(window).height()>$(document).height()-600&&(globalParameters.pageNumber=globalParameters.pageNumber+1,1!=globalParameters.pageNumber&&globalParameters.candidateListLength==globalParameters.pageContent)){var e=r.getAppliedFilters(),a={};a.pageNumber=globalParameters.pageNumber,a.pageContent=globalParameters.pageContent,a.tagId=e.tagId,showLoader(),fetchCandidatesByTags(a,recruiterId)}}$(window).scroll(function(){clearTimeout(t),t=setTimeout(n,100)})});
