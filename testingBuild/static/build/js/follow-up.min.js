...
function setCandidateAction(t,n,a,i,s,u){return postRequest(baseUrl+"/recruiter/"+t+"/job/"+n+"/application/"+i+"/action/"+a,null,s,function(t,n,e){if(t.status&&"success"==t.status)return t.action=a,t.parameters=u,t.applicationId=i,t.comment=s.comment,pubsub.publish("setCandidateActionSuccess",t)},function(t,n,e){return t.action=a,t.parameters=u,pubsub.publish("setCandidateActionFail",t)})}
function fetchFollowUps(s,u){console.log(u),getRequest(baseUrl+"/recruiter/"+s+"/followUps",u,function(s){s.status&&"success"==s.status&&pubsub.publish("fetchedFollowups",s.data)},function(s,u,o){return pubsub.publish("failedTofetchFollowups",s)})}
...
function candidateList(){var r={},a={};function i(t){var e,a,n=(e=t.userID,(a=$(r.candidateItemClass+".prototype").clone().removeClass("prototype hidden")).attr("data-candidate-id",e),{element:a,image:a.find(".candImage"),isOnline:a.find(".candStatus"),name:a.find(".candName"),experience:a.find(".candExperience"),location:a.find(".candCurrentLocation"),appliedOn:a.find(".candAppliedOn"),notice:a.find(".candNotice"),candTagList:a.find(".candTagListing"),eduList:a.find(".candEducationList"),profList:a.find(".candProfessionalList"),isProMember:a.find(".isProMember"),isFollowedUp:a.find(".isFollowedUp"),shortlistButton:a.find(r.candidateShortlistButtonClass),rejectButton:a.find(r.candidateRejectButtonClass),downloadResumeButton:a.find(r.candidateDownloadResumeButtonClass),candJobList:a.find(".jobListing"),multipleCandJobListContainer:a.find(".multipleJobListingContainer"),multipleJobListingText:a.find(".multipleJobListingText"),multipleCandJobListing:a.find(".multipleJobListing"),jobTitle:a.find(".jobTitle"),candidateViewProfileLink:a.find(".candidateViewProfile")});n.element.attr("data-application-id",t.id),n.element.attr("data-job-id",t.jobId),n.image.attr("src",t.img||"/static/images/noimage.png"),n.name.text(t.name||"NA"),n.experience.text(t.exp.year+"y "+t.exp.month+"m"||"NA"),n.location.text(t.currentLocation||"NA"),n.appliedOn.text(moment(t.timestamp,"x").format("DD-MM-YYYY")),7==t.notice?n.notice.text("Immediately Available"):1==t.notice?n.notice.text(t.notice+" month"):n.notice.text(t.notice+" months"),n.downloadResumeButton.attr("href",t.resume),n.downloadResumeButton.attr("download",t.name.replace(/ +/g,"_")+"_resume.pdf");var i=t.status;n.shortlistButton.attr("data-status",i),n.rejectButton.attr("data-status",i),1==i?n.shortlistButton.text("Shortlisted"):2==i&&n.rejectButton.text("Rejected");var l="";$.each(t.jobs,function(t,e){if(!(2<t)){var a,n={element:a=$(r.candidateProfessionalItemClass+".prototype").clone().removeClass("prototype hidden"),name:a.find(".companyName"),tenure:a.find(".candTenure"),designation:a.find(".candDesignation")};n.name.text(e.organization),n.designation.text(e.designation);var i=getMonthName(e.exp.from.month),d=getMonthName(e.exp.to.month),o=e.exp.from.year,s=e.exp.from.year,c=e.is_current?i+" - "+o+" to Present":i+" - "+o+" to "+d+" - "+s;n.tenure.text(c),l+=n.element[0].outerHTML}}),n.profList.html(l);var d="";return $.each(t.education,function(t,e){if(!(2<t)){var a,n={element:a=$(r.candidateEducationItemClass+".prototype").clone().removeClass("prototype hidden"),name:a.find(".instituteName"),batch:a.find(".candBatch"),degree:a.find(".candDegree")};n.name.text(e.institute),n.batch.text(e.batch.from+" - "+e.batch.to),n.degree.text(e.degree+"("+e.courseType+")"),d+=n.element[0].outerHTML}}),n.eduList.html(d),n.jobTitle.text(t.title),n.candidateViewProfileLink.attr("href","/job/"+t.jobId+"/applications/"+t.id),t.pro&&n.isProMember.removeClass("hidden"),n}return{init:function(){r.candidateListing=$("#candidateListing"),r.filterByTagList=$("#filterByTagList"),r.candidateItemClass=".candidateItem",r.candidateDownloadResumeButtonClass=".candDownloadResume",r.candidateProfessionalItemClass=".candProfessionalItem",r.candidateEducationItemClass=".candEducationItem",r.candAppliedJobsClass=".candAppliedJobs",r.candTagItemClass=".candTagItem",r.tagOptionClass=".tagOption",r.tagId=-1,r.candidateItemShell=$(".candidateItem.shell"),r.candAppliedJobsClass=".candAppliedJobs",r.multipleJobListingClass=".multipleJobListing",r.multipleJobListingTextClass=".multipleJobListingText",r.candidateShortlistButtonClass=".candidateShortlist",r.candidateRejectButtonClass=".candidateReject"},addToList:function(t,e,a){if(r.candidateItemShell.addClass("hidden"),t.length<1&&1==e)return r.candidateListing.append("<div class='no-data'>No Applications Found!</div>");var n="";return t.forEach(function(t,e){var a=i(t);n+=a.element[0].outerHTML}),r.candidateListing.append(n),t.length<a?r.candidateListing.append("<div class='no-data'>You have reached the end of the list</div>"):void 0},setConfig:function(t,e){a[t]=e},emptyCandidateList:function(){r.candidateListing.empty()},showShell:function(){r.candidateItemShell.removeClass("hidden")},onClickShortlistCandidate:function(n){r.candidateListing.on("click",r.candidateShortlistButtonClass,function(t){var e=$(this).closest(r.candidateItemClass).attr("data-application-id"),a=$(this).closest(r.candidateItemClass).attr("data-job-id");n(e,a)})},onClickRejectCandidate:function(n){r.candidateListing.on("click",r.candidateRejectButtonClass,function(t){var e=$(this).closest(r.candidateItemClass).attr("data-application-id"),a=$(this).closest(r.candidateItemClass).attr("data-job-id");n(e,a)})},candidateActionTransition:function(t){t.forEach(function(t){r.candidateListing.find(".candidateItem[data-application-id="+t+"]").slideUp("normal",function(){$(this).remove()})})},initializeDatePicker:function(e){$("#datepicker").datepicker({showOn:"button",buttonImage:"/static/images/smallcalendar.svg",buttonImageOnly:!0,changeMonth:!0,changeYear:!0,dateFormat:"yy-mm-dd",onSelect:function(){var t=$(this).val();e(t)}})}}}
var globalParameters={pageContent:10,pageNumber:1,candidateListLength:null,fromDate:moment().subtract(2,"months").format("YYYY-MM-DD")};function errorHandler(e){var t=e.responseJSON;return t?503!=e.status?toastNotify(3,t.message):void toastNotify(3,"Oops...something went wrong. Our engineers are fixing the issue"):toastNotify(3,"Looks like you are not connected to the internet")}jQuery(document).ready(function(){var r=candidateList();r.init();chatModelIndex();var e={};e.pageNumber=globalParameters.pageNumber,e.pageContent=globalParameters.pageContent,e.fromDate=globalParameters.fromDate,fetchFollowUps(recruiterId,e),r.initializeDatePicker(function(e){r.showShell();var t={};globalParameters.pageNumber=1,t.pageNumber=globalParameters.pageNumber,t.pageContent=globalParameters.pageContent,t.fromDate=e,globalParameters.fromDate=e,r.emptyCandidateList(),fetchFollowUps(recruiterId,t)}),r.onClickShortlistCandidate(function(e,t){var a={event_category:eventMap.shortlistCand.cat,event_label:"origin=FollowUpNotif,type=Single,recId="+recruiterId};sendEvent(eventMap.shortlistCand.event,a),setCandidateAction(recruiterId,t,"shortlist",e,{},{})}),r.onClickRejectCandidate(function(e,t){var a={event_category:eventMap.rejectCand.cat,event_label:"origin=FollowUpNotif,type=Single,recId="+recruiterId};sendEvent(eventMap.rejectCand.event,a),setCandidateAction(recruiterId,t,"reject",e,{},{})});var t;pubsub.subscribe("fetchedFollowups",function(e,t){hideLoader(),globalParameters.candidateListLength=t.length,r.addToList(t,globalParameters.pageNumber,globalParameters.pageContent)}),pubsub.subscribe("failedTofetchFollowups",function(e,t){errorHandler(t)}),pubsub.subscribe("setCandidateActionSuccess",function(e,t){var a=[];return a.push(t.applicationId),r.candidateActionTransition(a),function(){if(r.getApplicationsLength()<=2){var e={};globalParameters.pageNumber=globalParameters.pageNumber+1,e.pageNumber=globalParameters.pageNumber,e.pageContent=globalParameters.pageContent,showLoader(),fetchFollowUps(recruiterId,e)}}(),"shortlist"==t.action?toastNotify(1,"Candidate Successfully Shortlisted"):"rejected"==t.action?toastNotify(1,"Candidate Successfully Rejected"):void 0}),pubsub.subscribe("setCandidateActionFail",function(e,t){errorHandler(t)});function a(){if($(window).scrollTop()+$(window).height()>$(document).height()-600&&(globalParameters.pageNumber=globalParameters.pageNumber+1,1!=globalParameters.pageNumber&&globalParameters.candidateListLength==globalParameters.pageContent)){var e={};e.pageNumber=globalParameters.pageNumber,e.pageContent=globalParameters.pageContent,e.fromDate=globalParameters.fromDate,showLoader(),fetchFollowUps(recruiterId,e)}}$(window).scroll(function(){clearTimeout(t),t=setTimeout(a,100)})});
