...
var changePasswordForm=$(".change-password-form");$(document).ready(function(){changePasswordForm.find(".change-password").click(changePassword),changePasswordForm.find(".field input").focusout(function(){checkErrorClass(this)}),changePasswordForm.find(".field input").focusin(function(){removeErrorClass(this)})});var checkErrorClass=function(e){var s=$(e),a=s.val();return"password"==s.attr("name")||"newPassword"==s.attr("name")?""==a?(s.next().text("Please provide the password").removeClass("hidden"),!1):a.length<5?(s.next().text("Password must be of atleast five characters").removeClass("hidden"),!1):(s.next().addClass("hidden"),!0):"confirmPassword"==s.attr("name")?""==a?(s.next().text("Please provide the password").removeClass("hidden"),!1):a.length<5?(s.next().text("Password must be of atleast five characters").removeClass("hidden"),!1):$("#newPassword").val()!=$("#confirmPassword").val()?(s.next().text("Password and confirm Password should be same").removeClass("hidden"),!1):(s.next().addClass("hidden"),!0):void 0},removeErrorClass=function(e){$(e).next().addClass("hidden")},getValue=function(e,s){var a=$(e);return s[a.attr("name")]=a.val(),s},changePassword=function(){var e={};changePasswordForm.find(".field input").each(function(){e=getValue(this,e),console.log(e)}),checkErrorClass($("#password"))&&checkErrorClass($("#newPassword"))&&postRequest(baseUrl+"/recruiter/"+recruiterID+"/reset",{},e,successCallback)},successCallback=function(e){console.log(e)};
...
function fetchCandidatesByStatus(s,t){return getRequest(baseUrl+"/recruiter/"+t+"/applications",s,function(t){if(t.status&&"success"==t.status)return console.log(s),t.obj={},t.obj.pageNumber=s.pageNumber,t.obj.status=s.status,pubsub.publish("fetchCandidatesByStatusSuccess",t)},function(t,s,u){return pubsub.publish("fetchCandidatesByStatusFail",t)})}
...
function fetchJobApplications(t,s,e){return getRequest(baseUrl+"/recruiter/"+e+"/jobs/"+t+"/applications",s,function(t){if(t.status&&"success"==t.status)return t.pageNumber=s.pageNumber,t.offset=s.offset,t.obj={},t.obj.status=s.status,pubsub.publish("fetchedJobApplication",t)},function(t,s,e){return pubsub.publish("failedTofetchJobApplication",t)})}
...
function candidateList(){var c={},i={};function d(e){var t,i,n=(t=e.userID,(i=$(c.candidateItemClass+".prototype").clone().removeClass("prototype hidden")).attr("data-candidate-id",t),{element:i,image:i.find(".candImage"),isOnline:i.find(".candidateStatus"),name:i.find(".candName"),experience:i.find(".candExperience"),location:i.find(".candCurrentLocation"),appliedOn:i.find(".candAppliedOn"),notice:i.find(".candNotice"),candTagList:i.find(".candTagListing"),eduList:i.find(".candEducationList"),profList:i.find(".candProfessionalList"),isProMember:i.find(".isProMember"),isFollowedUp:i.find(".isFollowedUp"),downloadResumeButton:i.find(c.candidateDownloadResumeButtonClass),candJobList:i.find(".jobListing"),multipleCandJobListContainer:i.find(".multipleJobListingContainer"),multipleJobListingText:i.find(".multipleJobListingText"),multipleCandJobListing:i.find(".multipleJobListing"),jobTitle:i.find(".jobTitle"),candidateViewProfileLink:i.find(".candidateViewProfile")});n.element.attr("data-application-id",e.id),n.image.attr("src",e.img||"/static/images/noimage.png"),n.name.text(e.name||"NA"),n.experience.text(e.exp.year+"y "+e.exp.month+"m"||"NA"),n.location.text(e.currentLocation||"NA"),n.appliedOn.text(moment(e.timestamp,"x").format("DD-MM-YYYY")),7==e.notice?n.notice.text("Immediately Available"):1==e.notice?n.notice.text(e.notice+" month"):n.notice.text(e.notice+" months"),n.downloadResumeButton.attr("href",baseUrl+e.resume),n.downloadResumeButton.attr("download",e.name.replace(/ +/g,"_")+"_resume.pdf");var a="";$.each(e.tags,function(e,t){var i=$(c.candTagItemClass+".prototype").clone().removeClass("prototype hidden");i.find("a").text(t.name).attr("href","/candidates/tagged?queryTag="+t.id),a+=i[0].outerHTML}),n.candTagList.html(a);var r="";e.jobs=sortArrayOfObjectsByMultipleKey(e.jobs),$.each(e.jobs,function(e,t){if(!(2<e)){var i,n={element:i=$(c.candidateProfessionalItemClass+".prototype").clone().removeClass("prototype hidden"),name:i.find(".companyName"),tenure:i.find(".candTenure"),designation:i.find(".candDesignation")};if(n.name.text(t.organization),n.designation.text(t.designation),parseInt(t.exp.from.month)&&parseInt(t.exp.to.month)&&parseInt(t.exp.from.year)&&parseInt(t.exp.to.year)){var a=getMonthName(t.exp.from.month),o=getMonthName(t.exp.to.month),d=t.exp.from.year,s=t.exp.to.year,l=t.is_current?a+" , "+d+" to Present":a+" , "+d+" to "+o+" , "+s;n.tenure.text(l)}r+=n.element[0].outerHTML}}),n.profList.html(r);var o="";if($.each(e.education,function(e,t){if(!(2<e)){var i,n={element:i=$(c.candidateEducationItemClass+".prototype").clone().removeClass("prototype hidden"),name:i.find(".instituteName"),batch:i.find(".candBatch"),degree:i.find(".candDegree")};n.name.text(t.institute),n.batch.text(t.batch.from+" to "+t.batch.to),n.degree.text(t.degree+" ("+t.courseType+")"),o+=n.element[0].outerHTML}}),n.eduList.html(o),e.applications)if(1<e.applications.length){n.candJobList.addClass("hidden"),n.multipleJobListingText.text("Applied to "+e.applications.length+" jobs");var d="";$.each(e.applications,function(e,t){console.log(t);var i=$(c.candAppliedJobsClass+".prototype").clone().removeClass("prototype hidden");i.html(t.title+" -<a class='link-color candApplyPage' href='/job/"+t.jobID+"/applications/"+t.id+"'> View Profile</a> "),d+=i[0].outerHTML}),n.multipleCandJobListing.append(d),n.multipleCandJobListContainer.removeClass("hidden")}else 1==e.applications.length&&(n.jobTitle.text(e.applications[0].title),n.candidateViewProfileLink.attr("href","/job/"+e.applications[0].jobID+"/applications/"+e.applications[0].id));else n.jobTitle.text(c.jobTitle),n.candidateViewProfileLink.attr("href","/job/"+c.jobId+"/applications/"+e.id);return e.pro&&n.isProMember.removeClass("hidden"),e.follow&&n.isFollowedUp.removeClass("hidden"),n}return{init:function(){c.candidateListing=$("#candidateList"),c.filterByStatus=$("#filterByStatus"),c.filterByJob=$("#filterByJob"),c.candidateCount=$("#candidateCount"),c.candidateItemClass=".candidateItem",c.candidateDownloadResumeButtonClass=".candDownloadResume",c.candidateProfessionalItemClass=".candProfessionalItem",c.candidateEducationItemClass=".candEducationItem",c.candTagItemClass=".candTagItem",c.candJobOption=".candJobOption",c.multipleJobListingClass=".multipleJobListing",c.multipleJobListingTextClass=".multipleJobListingText",c.candAppliedJobsClass=".candAppliedJobs",c.candidateItemShell=$(".candidateItem.shell"),c.emptyView=$(".empty-screen"),c.stats=$(".stats"),c.status="1,3",c.jobId=-1,c.jobTitle="",c.candidateListing.on("click",c.multipleJobListingTextClass,function(){$(this).siblings(".multipleJobListing").slideToggle()}),jQuery(".header .menu-list-item.my-jobs").addClass("active"),c.candidateListing.on("click",".candApplyPage",function(){var e={event_category:eventMap.viewCandidProfile.cat,event_label:"origin=TaggedList,type=CardClick,recId="+recruiterId};sendEvent(eventMap.viewCandidProfile.event,e)})},addToList:function(e,t,i){c.candidateItemShell.addClass("hidden");var n=c.filterByStatus.val(),a=c.filterByJob.val();if(e.length<1&&1==t)return-1==a&&"1,3"===n?(c.emptyView.removeClass("hidden"),void c.stats.addClass("hidden")):($(".user-text").text("We couldn’t find any matches for the selected filter."),$(".empty-text").text("Please select a different filter"),$(".image-container img").attr("src","/static/images/tagged.svg"),void c.emptyView.removeClass("hidden"));c.emptyView.addClass("hidden");var o="";return e.forEach(function(e,t){var i=d(e);o+=i.element[0].outerHTML}),c.candidateListing.append(o),e.length<i&&0==c.candidateListing.find(".no-more-records").length?c.candidateListing.append("<div class='no-more-records no-data'>You have reached the end of the list</div>"):void 0},setConfig:function(e,t){i[e]=t},emptyCandidateList:function(){c.candidateListing.empty()},onFilterByStatus:function(t){c.filterByStatus.change(function(){var e=$(this).val();return c.status=e,t()})},onFilterByJob:function(t){c.filterByJob.change(function(){var e=$(this).val();return c.jobId=e,c.jobTitle=$(this).find("option:selected").text(),t()})},populateJobsDropdown:function(e){var n="";e.forEach(function(e,t){var i={element:$(c.candJobOption+".prototype").clone().removeClass("prototype hidden")};i.element.text(e.title),i.element.val(e.publishedId),n+=i.element[0].outerHTML}),c.filterByJob.append(n)},showCandidateCount:function(e){c.candidateCount.text(e)},getAppliedFilters:function(){var e={};return e.status=c.status,e.jobId=c.jobId,e},showShell:function(){c.candidateItemShell.removeClass("hidden")}}}
var globalParameters={pageContent:10,pageNumber:1,status:"1,3",candidateListLength:null,jobId:-1};function errorHandler(e){var t=e.responseJSON;return t?503!=e.status?toastNotify(3,t.message):void toastNotify(3,"Oops...something went wrong. Our engineers are fixing the issue"):toastNotify(3,"Looks like you are not connected to the internet")}jQuery(document).ready(function(){var r=candidateList();r.init();var e={};e.status=globalParameters.status,e.pageNumber=globalParameters.pageNumber,e.pageContent=globalParameters.pageContent;chatModelIndex();var t={};function a(e,t){hideLoader(),globalParameters.candidateListLength=t.data.length,t.stats?"1,3"==t.obj.status?r.showCandidateCount(t.stats.shortlisted+t.stats.save):"1"==t.obj.status?r.showCandidateCount(t.stats.shortlisted):"3"==t.obj.status&&r.showCandidateCount(t.stats.save):r.showCandidateCount(0),r.addToList(t.data,globalParameters.pageNumber,globalParameters.pageContent)}function s(e,t){errorHandler(data)}t.type="everPublished",fetchJobs(t,recruiterId),fetchCandidatesByStatus(e,recruiterId),r.onFilterByStatus(function(){var e={event_category:eventMap.filterShortlisted.cat,event_label:"origin=SavedShorlistedList,Type=CandidateStatus,recId="+recruiterId};sendEvent(eventMap.filterShortlisted.event,e);var t=r.getAppliedFilters(),a={};if(globalParameters.pageNumber=1,a.pageNumber=globalParameters.pageNumber,a.pageContent=globalParameters.pageContent,a.status=t.status,r.emptyCandidateList(),r.showShell(),-1==parseInt(t.jobId))return fetchCandidatesByStatus(a,recruiterId);fetchJobApplications(t.jobId,a,recruiterId)}),r.onFilterByJob(function(){var e={event_category:eventMap.filterShortlisted.cat,event_label:"origin=SavedShorlistedList,Type=Job,recId="+recruiterId};sendEvent(eventMap.filterShortlisted.event,e);var t=r.getAppliedFilters(),a={};if(globalParameters.pageNumber=1,a.pageNumber=globalParameters.pageNumber,a.pageContent=globalParameters.pageContent,a.status=t.status,r.emptyCandidateList(),r.showShell(),-1==parseInt(t.jobId))return fetchCandidatesByStatus(a,recruiterId);fetchJobApplications(t.jobId,a,recruiterId)});var o;pubsub.subscribe("fetchCandidatesByStatusSuccess",a),pubsub.subscribe("fetchCandidatesByStatusFail",s),pubsub.subscribe("fetchedJobs",function(e,t){r.populateJobsDropdown(t)}),pubsub.subscribe("fetchJobsFail",function(e,t){errorHandler(t)}),pubsub.subscribe("fetchedJobApplication",a),pubsub.subscribe("failedTofetchJobApplication",s);function n(){if($(window).scrollTop()+$(window).height()>$(document).height()-600&&(globalParameters.pageNumber=globalParameters.pageNumber+1,1!=globalParameters.pageNumber&&globalParameters.candidateListLength==globalParameters.pageContent)){var e=r.getAppliedFilters(),t={};if(t.pageNumber=globalParameters.pageNumber,t.pageContent=globalParameters.pageContent,t.status=e.status,showLoader(),-1==parseInt(e.jobId))return fetchCandidatesByStatus(t,recruiterId);fetchJobApplications(e.jobId,t,recruiterId)}}$(window).scroll(function(){clearTimeout(o),o=setTimeout(n,100)})});
