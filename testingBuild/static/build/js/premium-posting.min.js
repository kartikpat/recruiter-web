...
function Swipe(e,r){"use strict";var t=function(){},s=function(n){setTimeout(n||t,0)},a={addEventListener:!!window.addEventListener,touch:"ontouchstart"in window||window.DocumentTouch&&document instanceof DocumentTouch,transitions:function(n){var t=["transitionProperty","WebkitTransition","MozTransition","OTransition","msTransition"];for(var e in t)if(void 0!==n.style[t[e]])return!0;return!1}(document.createElement("swipe"))};if(e){var u,c,d,i,l=e.children[0];r=r||{};var v=parseInt(r.startSlide,10)||0,h=r.speed||300;r.continuous=void 0===r.continuous||r.continuous;var n,f,w=r.auto||0,E={},p={},m={handleEvent:function(n){switch(n.type){case"touchstart":this.start(n);break;case"touchmove":this.move(n);break;case"touchend":s(this.end(n));break;case"webkitTransitionEnd":case"msTransitionEnd":case"oTransitionEnd":case"otransitionend":case"transitionend":s(this.transitionEnd(n));break;case"resize":s(o)}r.stopPropagation&&n.stopPropagation()},start:function(n){var t=n.touches[0];E={x:t.pageX,y:t.pageY,time:+new Date},f=void 0,p={},l.addEventListener("touchmove",this,!1),l.addEventListener("touchend",this,!1)},move:function(n){if(!(1<n.touches.length||n.scale&&1!==n.scale)){r.disableScroll&&n.preventDefault();var t=n.touches[0];p={x:t.pageX-E.x,y:t.pageY-E.y},void 0===f&&(f=!!(f||Math.abs(p.x)<Math.abs(p.y))),f||(n.preventDefault(),k(),r.continuous?(y(b(v-1),p.x+c[b(v-1)],0),y(v,p.x+c[v],0),y(b(v+1),p.x+c[b(v+1)],0)):(p.x=p.x/(!v&&0<p.x||v==u.length-1&&p.x<0?Math.abs(p.x)/d+1:1),y(v-1,p.x+c[v-1],0),y(v,p.x+c[v],0),y(v+1,p.x+c[v+1],0)))}},end:function(n){var t=+new Date-E.time,e=Number(t)<250&&20<Math.abs(p.x)||Math.abs(p.x)>d/2,i=!v&&0<p.x||v==u.length-1&&p.x<0;r.continuous&&(i=!1);var o=p.x<0;f||(e&&!i?(o?(r.continuous?(T(b(v-1),-d,0),T(b(v+2),d,0)):T(v-1,-d,0),T(v,c[v]-d,h),T(b(v+1),c[b(v+1)]-d,h),v=b(v+1)):(r.continuous?(T(b(v+1),d,0),T(b(v-2),-d,0)):T(v+1,d,0),T(v,c[v]+d,h),T(b(v-1),c[b(v-1)]+d,h),v=b(v-1)),r.callback&&r.callback(v,u[v])):r.continuous?(T(b(v-1),-d,h),T(v,0,h),T(b(v+1),d,h)):(T(v-1,-d,h),T(v,0,h),T(v+1,d,h))),l.removeEventListener("touchmove",m,!1),l.removeEventListener("touchend",m,!1)},transitionEnd:function(n){parseInt(n.target.getAttribute("data-index"),10)==v&&(w&&L(),r.transitionEnd&&r.transitionEnd.call(n,v,u[v]))}};return o(),w&&L(),a.addEventListener?(a.touch&&l.addEventListener("touchstart",m,!1),a.transitions&&(l.addEventListener("webkitTransitionEnd",m,!1),l.addEventListener("msTransitionEnd",m,!1),l.addEventListener("oTransitionEnd",m,!1),l.addEventListener("otransitionend",m,!1),l.addEventListener("transitionend",m,!1)),window.addEventListener("resize",m,!1)):window.onresize=function(){o()},{setup:function(){o()},slide:function(n,t){k(),g(n,t)},prev:function(){k(),r.continuous?g(v-1):v&&g(v-1)},next:function(){k(),x()},stop:function(){k()},getPos:function(){return v},getNumSlides:function(){return i},kill:function(){k(),l.style.width="",l.style.left="";for(var n=u.length;n--;){var t=u[n];t.style.width="",t.style.left="",a.transitions&&y(n,0,0)}a.addEventListener?(l.removeEventListener("touchstart",m,!1),l.removeEventListener("webkitTransitionEnd",m,!1),l.removeEventListener("msTransitionEnd",m,!1),l.removeEventListener("oTransitionEnd",m,!1),l.removeEventListener("otransitionend",m,!1),l.removeEventListener("transitionend",m,!1),window.removeEventListener("resize",m,!1)):window.onresize=null}}}function o(){u=l.children,i=u.length,u.length<2&&(r.continuous=!1),a.transitions&&r.continuous&&u.length<3&&(l.appendChild(u[0].cloneNode(!0)),l.appendChild(l.children[1].cloneNode(!0)),u=l.children),c=new Array(u.length),d=e.getBoundingClientRect().width||e.offsetWidth,l.style.width=u.length*d+"px";for(var n=u.length;n--;){var t=u[n];t.style.width=d+"px",t.setAttribute("data-index",n),a.transitions&&(t.style.left=n*-d+"px",T(n,n<v?-d:v<n?d:0,0))}r.continuous&&a.transitions&&(T(b(v-1),-d,0),T(b(v+1),d,0)),a.transitions||(l.style.left=v*-d+"px"),e.style.visibility="visible"}function x(){r.continuous?g(v+1):v<u.length-1&&g(v+1)}function b(n){return(u.length+n%u.length)%u.length}function g(n,t){if(v!=n){if(a.transitions){var e=Math.abs(v-n)/(v-n);if(r.continuous){var i=e;(e=-c[b(n)]/d)!==i&&(n=-e*u.length+n)}for(var o=Math.abs(v-n)-1;o--;)T(b((v<n?n:v)-o-1),d*e,0);n=b(n),T(v,d*e,t||h),T(n,0,t||h),r.continuous&&T(b(n-e),-d*e,0)}else n=b(n),function(t,e,i){if(!i)return l.style.left=e+"px";var o=+new Date,s=setInterval(function(){var n=+new Date-o;if(i<n)return l.style.left=e+"px",w&&L(),r.transitionEnd&&r.transitionEnd.call(event,v,u[v]),void clearInterval(s);l.style.left=(e-t)*(Math.floor(n/i*100)/100)+t+"px"},4)}(v*-d,n*-d,t||h);v=n,s(r.callback&&r.callback(v,u[v]))}}function T(n,t,e){y(n,t,e),c[n]=t}function y(n,t,e){var i=u[n],o=i&&i.style;o&&(o.webkitTransitionDuration=o.MozTransitionDuration=o.msTransitionDuration=o.OTransitionDuration=o.transitionDuration=e+"ms",o.webkitTransform="translate("+t+"px,0)translateZ(0)",o.msTransform=o.MozTransform=o.OTransform="translateX("+t+"px)")}function L(){n=setTimeout(x,w)}function k(){w=0,clearTimeout(n)}}(window.jQuery||window.Zepto)&&function(t){t.fn.Swipe=function(n){return this.each(function(){t(this).data("Swipe",new Swipe(t(this)[0],n))})}}(window.jQuery||window.Zepto);
var isSuccess;$(document).ready(function(){$(".close-modal, .close").click(closeModal),window.mySwipe=$(".mobile-swipe-container").Swipe().data("Swipe")});var closeModal=function(){$(".modal").addClass("hidden")};
...
function buyPlan(e,r){postRequest(baseUrl+"/recruiter/"+e+"/buy-continue",{},r,function(e){if(e.status&&"success"==e.status)return e.extraParameters={},e.extraParameters=r,pubsub.publish("buyPlanSuccess",e)},function(e,u,t){return e.extraParameters={},e.extraParameters=r,pubsub.publish("buyPlanFail",e)})}
function buyPlanClick(e,s){postRequest(baseUrl+"/recruiter/"+e+"/buy",{},s,function(e){if(e.status&&"success"==e.status)return e.extraParameters={},e.extraParameters=s,pubsub.publish("buyPlanClickSuccess",e)},function(e,u,r){return e.extraParameters={},e.extraParameters=s,pubsub.publish("buyPlanClickFail",e)})}
...
function Plans(){var i={};return{init:function(){i.planContinue=$(".planContinue"),i.signatureBuy=$(".signatureBuy"),i.signatureContinue=$(".signature-continue"),i.platinumContinue=$(".platinum-continue"),i.platinumBuy=$(".platinumBuy"),i.planType="",i.signatureModal=$("#signature-modal"),i.platinumModal=$("#platinum-modal"),i.basicBuy=$(".basic-buy"),i.basicBuy.click(function(){window.location=staticEndPoints.myJobs}),$(".modal").find("input").keyup(function(n){13!==n.keyCode&&$(".modal").find("input").next().addClass("hidden")})},onClickBuyPlan:function(a){i.planContinue.click(function(){var n=$(this).attr("data-plantype"),i=$(this).closest(".modal").find("input"),e=i.val().trim();e?e&&i.val()&&isValidPhone(i.val())?a(e,n):i.next().text("Please enter a valid 10 digit number").removeClass("hidden"):i.next().text("Please enter your contact number").removeClass("hidden")})},onClickSignatureBuy:function(e){i.signatureBuy.click(function(n){var i=$(this).attr("data-plantype");e(i)})},onClickPlatinumBuy:function(e){i.platinumBuy.click(function(n){var i=$(this).attr("data-plantype");e(i)})},openModal:function(n){"signature"==n?(addBodyFixed(),i.signatureModal.removeClass("hidden")):"platinum"==n&&(addBodyFixed(),i.platinumModal.removeClass("hidden"))},showSpinner:function(n){"signature"==n?(i.signatureBuy.addClass("hidden"),i.signatureBuy.prev().removeClass("hidden")):"platinum"==n&&(i.platinumBuy.addClass("hidden"),i.platinumBuy.prev().removeClass("hidden"))},hideSpinner:function(n){"signature"==n?(i.signatureBuy.removeClass("hidden"),i.signatureBuy.prev().addClass("hidden")):"platinum"==n&&(i.platinumBuy.removeClass("hidden"),i.platinumBuy.prev().addClass("hidden"))},showContinueSpinner:function(n){"signature"==n?(i.signatureContinue.addClass("hidden"),i.signatureContinue.prev().removeClass("hidden")):"platinum"==n&&(i.platinumContinue.addClass("hidden"),i.platinumContinue.prev().removeClass("hidden"))},hideContinueSpinner:function(n){"signature"==n?(i.signatureContinue.removeClass("hidden"),i.signatureContinue.prev().addClass("hidden")):"platinum"==n&&(i.platinumContinue.removeClass("hidden"),i.platinumContinue.prev().addClass("hidden"))},closeModal:function(){removeBodyFixed(),$(".modal").addClass("hidden")}}}
function errorHandler(e){var n=e.responseJSON;return n?503!=e.status?toastNotify(3,n.message):void toastNotify(3,"Oops...something went wrong. Our engineers are fixing the issue"):toastNotify(3,"Looks like you are not connected to the internet")}jQuery(document).ready(function(){var e,n=getQueryParameter("jobPostMessage"),r=getQueryParameter("jobId");isEmpty(r)&&(r=0),isEmpty(r)||(e=removeParam("jobId",window.location.href),window.history.replaceState("object or string","Title",e)),isEmpty(n)||(toastNotify(1,decodeURIComponent(n)),e=removeParam("jobPostMessage",window.location.href),window.history.replaceState("object or string","Title",e));var i=Plans();i.init(),i.onClickSignatureBuy(function(e){i.showSpinner("signature");var n={};n.email=profile.email,n.phone=profile.phone,n.planName=e,n.jobId=r,n.recruiterName=profile.name,buyPlanClick(recruiterId,n)}),i.onClickPlatinumBuy(function(e){i.showSpinner("platinum");var n={};n.email=profile.email,n.phone=profile.phone,n.planName=e,n.jobId=r,n.recruiterName=profile.name,buyPlanClick(recruiterId,n)}),i.onClickBuyPlan(function(e,n){i.showContinueSpinner(n);var a={};a.email=profile.email,a.phone=e,a.planName=n,a.jobId=r,a.recruiterName=profile.name,buyPlan(recruiterId,a)});pubsub.subscribe("buyPlanClickSuccess",function(e,n){"signature"==n.extraParameters.planName&&(i.hideSpinner("signature"),i.openModal("signature")),"platinum"==n.extraParameters.planName&&(i.hideSpinner("platinum"),i.openModal("platinum"))}),pubsub.subscribe("buyPlanClickFail",function(e,n){"signature"==n.extraParameters.planName&&i.hideSpinner("signature"),"platinum"==n.extraParameters.planName&&i.hideSpinner("platinum"),errorHandler(n)}),pubsub.subscribe("buyPlanSuccess",function(e,n){"signature"==n.extraParameters.planName&&(i.hideContinueSpinner("signature"),i.closeModal()),"platinum"==n.extraParameters.planName&&(i.hideContinueSpinner("platinum"),i.closeModal()),window.location=staticEndPoints.myJobs}),pubsub.subscribe("buyPlanFail",function(e,n){"signature"==n.extraParameters.planName&&i.hideContinueSpinner("signature"),"platinum"==n.extraParameters.planName&&i.hideContinueSpinner("platinum"),errorHandler(n)})});
