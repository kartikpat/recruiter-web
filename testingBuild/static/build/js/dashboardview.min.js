...
function onBoarding(){var n={};return{init:function(){n.profile=$(".upload-profile"),n.facebookConnect=$(".facebookContainer"),n.linkedinConnect=$(".linkedinContainer"),n.twitterConnect=$(".twitterContainer")},connect:function(){n.profile.on("click",function(){window.location=staticEndPoints.recruiterProfile}),n.facebookConnect.on("click",function(){window.open("/auth/facebook/",""," scrollbars=yes,menubar=no,width=500,height=500, resizable=yes,toolbar=no,location=no,status=no")}),n.linkedinConnect.on("click",function(){window.open("/auth/linkedin/",""," scrollbars=yes,menubar=no,width=500,height=500, resizable=yes,toolbar=no,location=no,status=no")}),n.twitterConnect.on("click",function(){window.open("/auth/twitter",""," scrollbars=yes,menubar=no,width=500,height=500, resizable=yes,toolbar=no,location=no,status=no")})},connected:function(){1==profile.linkedin&&(n.linkedinConnect.css("background"," #f3fbfb "),n.linkedinConnect.find(".triangle").removeClass("hidden"),n.linkedinConnect.find(".icon-container").removeClass("hidden")),1==profile.twitter&&(n.twitterConnect.css("background"," #f3fbfb "),n.twitterConnect.find(".triangle").removeClass("hidden"),n.twitterConnect.find(".icon-container").removeClass("hidden")),1==profile.facebook&&(n.facebookConnect.css("background"," #f3fbfb "),n.facebookConnect.find(".triangle").removeClass("hidden"),n.facebookConnect.find(".icon-container").removeClass("hidden"))}}}
$(document).ready(function(){var n=onBoarding();n.init(),n.connect(),n.connected()});
