"function"!=typeof String.prototype.trim&&(String.prototype.trim=function(){return this.replace(/^\s+|\s+$/g,"")}),Object.keys||(Object.keys=function(){"use strict";var n=Object.prototype.hasOwnProperty,i=!{toString:null}.propertyIsEnumerable("toString"),p=["toString","toLocaleString","valueOf","hasOwnProperty","isPrototypeOf","propertyIsEnumerable","constructor"],c=p.length;return function(t){if("function"!=typeof t&&("object"!=typeof t||null===t))throw new TypeError("Object.keys called on non-object");var r,o,e=[];for(r in t)n.call(t,r)&&e.push(r);if(i)for(o=0;o<c;o++)n.call(t,p[o])&&e.push(p[o]);return e}}()),Array.prototype.forEach||(Array.prototype.forEach=function(t){var r,o;if(null==this)throw new TypeError("this is null or not defined");var e=Object(this),n=e.length>>>0;if("function"!=typeof t)throw new TypeError(t+" is not a function");for(1<arguments.length&&(r=arguments[1]),o=0;o<n;){var i;o in e&&(i=e[o],t.call(r,i,o,e)),o++}});
...
function submitCalendarIe(e,s,n){console.log(e),postRequest("/recruiter/"+n+"/calendar/"+s,{"Content-Type":"application/json"},JSON.stringify(e),function(s){if(console.log(s.status),console.log(e),s.status&&"success"==s.status)return pubsub.publish("submittedCalendarIe",s)},function(s,e,n){return pubsub.publish("failedCalendarSubmissionIe",s)})}
function fetchCalendarsIe(e,t){return getRequest(baseUrl_local+"/recruiter/"+t+"/calendar/"+e,{},function(e){if(e.status&&"success"==e.status)return pubsub.publish("fetchedCalendarsIe",e.data)},function(e,t,u){return pubsub.publish("failedToFetchCalendarsIe",e)})}
...
$(document).ready(function(){var r=Calendar();if($.support.cors=!0,calendarId){var e=getQueryParameter("insuffSlotsErrMsg");if(!isEmpty(e)){toastNotify(3,"All the slots have been booked by the candidates. Please add more slots to send interview invite");var a=removeParam("insuffSlotsErrMsg",window.location.href);window.history.replaceState("object or string","Title",a)}fetchCalendarsIe(calendarId,recruiterId),$(".form-container").removeClass("hidden"),$(".Availability").removeClass("hidden"),$(".second-container ").removeClass("hidden"),$(".bottom-container ").removeClass("hidden"),$(".loaderScroller").addClass("hidden")}r.init(),r.submitHandler(function(e){if("update"==e){var a={event_category:eventMap.calendarEdit.cat,event_label:"origin=ManageCalendar,source=CalendarForm,recId="+recruiterId};sendEvent(eventMap.calendarEdit.event,a)}else{a={event_category:eventMap.createCalendar.cat,event_label:"origin=ManageCalendar,source=CalendarForm,recId="+recruiterId};sendEvent(eventMap.createCalendar.event,a)}if(r.validate()){t();var n=r.getDetails();submitCalendarIe(n,calendarId,recruiterId)}});pubsub.subscribe("submittedCalendarIe",function(e,a){t(),window.location=staticEndPoints.manageCalendars}),pubsub.subscribe("failedCalendarSubmissionIe",function(e,a){console.log("failedSuccess"),console.log(e),console.log(a),$("#submit").removeClass("hidden"),$(".spinner").addClass("hidden")}),pubsub.subscribe("fetchedCalendarsIe",function(e,a){r.setDetails(a)}),pubsub.subscribe("failedToFetchCalendarsIe",function(e,a){alert(res.status)});function t(){$("#submit").addClass("hidden"),$(".spinner").removeClass("hidden")}});
var errorResponses={missingName:"Please enter a calendar name",missingMessage:"Please enter a message for F2F interview",missingTeleMessage:"Please enter a message for telephonic interview",missingvalues:"Please select your available hours",missingslots:"Please select a slot",missingDate:"Please select a end Date",missingStart:"Please select Start Time",missingEnd:"Please select End Time",missingDateSlot:"Please select a slot between startdate and endate"};function Calendar(){var c={},m={};function n(){var l=[],o=[],e={},t={},a=moment().format("YYYY-MM-DD"),r=a,n="";1==$("#radio-button-startend").is(":checked")&&""==(r=$("#start_date").datepicker().val())&&(r=a),1==$("#radio-button-start").is(":checked")&&(r=a,$("#startdatepicker").datepicker("setDate",null)),1==$("#radio-button-tillend").is(":checked")&&(n="0000-00-00",$("#enddatepicker").datepicker("setDate",null)),1==$("#radio-button-end").is(":checked")&&(n=$("#end_date").datepicker().val()),e.from=r,e.to=n,m.date=e,c.dayId.each(function(e,t){var a=$(this).attr("id"),r=$(this).find(".day").attr("id"),n=$(this).attr("slotId");$("#"+a).css("opacity","0.5");var o=$("#"+a).find(c.checkbox).is(":checked");1==o&&$("#"+a).css("opacity","1");var s=$("#"+a).find(c.start_timeClass).val();0<s&&f(a);var i=$("#"+a).find(c.end_timeClass).val();if(0<i&&p(a),0<parseInt(s,10)&&0<parseInt(i,10)&&1==o){var d={day:a,id:r,slotId:n,time:{from:s,to:i}};l.push(d)}});var s=c.breakStart.val(),i=c.breakEnd.val();return t.from=s,f("breaks"),t.to=i,p("breaks"),m.breakHours=t,0<parseInt(s,10)&&0<parseInt(i,10)?(l.forEach(function(e){if(parseInt(s,10)>parseInt(e.time.to,10))o.push(e);else if(parseInt(s,10)>parseInt(e.time.from,10)&&parseInt(i,10)>parseInt(e.time.to,10))e.time.to=s,o.push(e);else if(parseInt(s,10)<=parseInt(e.time.from,10)&&parseInt(i,10)>=parseInt(e.time.to));else if(parseInt(s,10)<parseInt(e.time.from,10)&&parseInt(i,10)<parseInt(e.time.to,10)&&parseInt(i)>parseInt(e.time.from,10))e.time.from=i,o.push(e);else if(parseInt(s,10)<parseInt(e.time.from,10)&&parseInt(i,10)<parseInt(e.time.to,10))o.push(e);else{var t=e.time.to;e.time.to=s;var a=i,r=0;if(e.time.to!=e.time.from&&(o.push(e),r++),t!=a){var n={day:e.day,time:{from:a,to:t}};1<r&&(n.id=e.id),o.push(n)}}}),m.slots=o):m.slots=l,{toDate:n,fromDate:r,highlightSlots:m.slots}}function o(e,t,a){e=moment(e).format("YYYY-MM-DD");var r={1:"mon",2:"tue",3:"wed",4:"thu",5:"fri",6:"sat",7:"sun"};$(".TimeLines").css({"text-decoration":"line-through",opacity:"1",color:"#b0b0b0"});for(var n=0;n<a.length;n++){var o=parseInt(a[n].time.from,10),s=parseInt(a[n].time.to,10),i=a[n].day,d=moment($(".fc-"+r[i]).attr("data-date")),l=moment(e),c=moment(t);if(t&&c.isBefore(d))break;if(console.log(l),console.log(d),console.log(!(l.isBefore(d)||l.isSame(d))),l.isBefore(d)||l.isSame(d))for(var m=parseInt(o,10);m<parseInt(s,10);m+=30)30==m?$(".fc-"+r[i]).find("#hours-030").css({"text-decoration":"none",opacity:"1",color:"#149075"}):0==m?$(".fc-"+r[i]).find("#hours-000").css({"text-decoration":"none",opacity:"1",color:"#149075"}):$(".fc-"+r[i]).find("#hours-"+m).css({"text-decoration":"none",opacity:"1",color:"#149075"}),m%100!=0&&(m+=40)}}function e(){for(var e=c.select_menu,t="AM",a=8;a<=22;a++){var r=12<a?a-12:a;r=r<10?"0"+r:r,11<(a=a<10?"0"+a:a)&&(t="PM");for(var n=0;n<60;n+=30){var o=n<30?"00":n;if(e.append("<option value="+a+o+">"+r+":"+o+" "+t+"</option>"),22==a)break}}}function t(){$(document).on("mouseenter",".dayId",function(){$(this).find(".button-container").show().css("display","inline-block")}).on("mouseleave",".dayId",function(){$(this).find(".button-container").hide()})}function f(e){var t=$("#"+e).find(".start"),a=($("#"+e).find(".end"),parseInt(t.val(),10)),r=$("#"+e+" .start").find("option:selected").index();if(0<=a&&r<27){$("#"+e+" .end").find("option:selected").index();$("#"+e+" .end").find("option").prop("disabled",!1),$("#"+e+" .end").not("#"+e+" .start").find("option:lt("+(r+1)+")").prop("disabled",!0),$("#"+e+" .end").find("option:first-child").prop("disabled",!1)}}function p(e){$("#"+e).find(".start"),$("#"+e).find(".end");var t=$("#"+e+" .end").find("option:selected").index();$("#"+e+" .start").find("option").prop("disabled",!1),$("#"+e+" .start").not("#"+e+" .end").find("option:gt("+(t-1)+")").prop("disabled",!0)}function a(){c.copytoall.on("click",function(){var e=$(this).parent().parent().parent().attr("id");console.log(e);var t=$("#"+e).find(c.start_time).val(),a=$("#"+e).find(c.end_time).val();1==$("#"+e).find(c.checkbox).is(":checked")&&0<t&&0<a&&($('input[type="checkbox"]',c.table).prop("checked",!0),c.start_time.val(t),c.end_time.val(a));n()})}function r(e){for(var t="AM",a=8;a<23;a++){var r=12<a?a-12:a;r=r<10?"0"+r:r,11<a&&(t="PM");for(var n=0;n<60;n+=30){var o=n<30?"00":n;if($(".fc-day").append('<div id="hours-'+a+o+'" class="TimeLines">'+r+":"+o+" "+t+"</div>"),22==a)break}}}function s(){$("#startdatepicker").datepicker({buttonImage:"/static/images/calenderIe.png",buttonImageOnly:!0,changeMonth:!0,changeYear:!0,dateFormat:"dd-mm-yy",altField:"#start_date",altFormat:"yy-mm-dd",showOn:"both",minDate:0,onSelect:function(e,t){$("#radio-button-startend").prop("checked","true");n()}})}function i(){$("#enddatepicker").datepicker({buttonImage:"/static/images/calenderIe.png",buttonImageOnly:!0,changeMonth:!0,changeYear:!0,dateFormat:"dd-mm-yy",altField:"#end_date",altFormat:"yy-mm-dd",showOn:"both",minDate:0,onSelect:function(e,t){$("#radio-button-end").prop("checked","true");n()}})}function d(e){e.focus(),e.addClass("error-border"),$("html, body").animate({scrollTop:e.closest(".form").offset().top},200)}function l(){var e=moment(m.date.from),t=(e.day(),moment(m.date.to)),a=t.day(),r=e.day(),n=t.day();0==r&&(r=7),0==n&&(n=7);var o=0;if(0==a&&(a=7),"0000-00-00"!=m.date.to){var s=t.diff(e,"weeks");if(console.log(r),console.log(n),0<s)return!0;for(var i=0;i<m.slots.length;i++){var d=m.slots[i].day;d=parseInt(d),n<r&&(r<=d||d<=n)?o++:r<=n&&r<=d&&d<=n&&o++}if(0==o)return c.slots.find(".error").text(errorResponses.missingDateSlot),$("html, body").animate({scrollTop:c.slots.closest(".second-container").offset().top},200),!0}}return{init:function(){c.name=$("#name"),c.message=$("#message"),c.teleMessage=$("#telephonic"),c.select_menu=$(".select-dropdown"),c.button=$("#selectAll"),c.copytoall=$(".copyToAll"),c.check_button=$("#check-button-mon"),c.start_time=$(".Start-time"),c.end_timeClass=".End-time",c.start_timeClass=".Start-time",c.end_time=$(".End-time"),c.copy=$("body"),c.table=$("#example"),c.element1=$("#selectElementId-1"),c.element2=$("#selectElementId-2"),c.check=$(".Checked"),c.dayId=$(".dayId"),c.checkbox=$(".check-button"),c.breakStart=$(".Break-start"),c.breakEnd=$(".Break-end"),c.breakhours=$(".Breaks-available"),c.fullcalendar=$("#calendar"),c.Calendarhours=$(".fc-day"),c.Highlighter=$(".highlighter"),c.startDate=$("#startdatepicker"),c.endDate=$("#enddatepicker"),c.start=$(".start"),c.end=$(".end"),c.firstDay=$("#1"),c.error=$(".errors"),c.slots=$(".table"),c.prevButton=$(".button-prev"),c.nextButton=$(".button-next"),c.Calendarbutton=$(".calendar-button"),c.textBox=$(".field p"),c.submitButton=$("#submit"),c.radioInput=$(".radio-input"),t(),r(),a(),e(),s(),i()},selectCreater:e,copytoall:t,copyTime:a,startTimeMapper:f,endTimeMapper:p,fullCalendar:function(){c.fullcalendar.fullCalendar({header:{right:"title,prev,next",left:""},navLinks:!1,businessHours:!1,defaultView:"basicWeek",columnFormat:"ddd \n D/M/Y"}),c.prevButton.on("click",function(){c.fullcalendar.fullCalendar("prev"),r()}),c.nextButton.on("click",function(){c.fullcalendar.fullCalendar("next"),r()})},highlighter:function(){c.Highlighter.on("change",function(e){e.preventDefault();var t,a=$(this).parent().parent().parent().parent().attr("id");console.log(a),t=a,console.log(t),$("#"+t).find(".error-slot").text(""),$("#"+t).find(".error").text("");var r=n();o(r.fromDate,r.toDate,r.highlightSlots)}),c.Calendarbutton.on("click",function(e){e.preventDefault();var t=n();o(t.fromDate,t.toDate,t.highlightSlots)}),c.button.on("click",function(e){e.preventDefault();var t=n();o(t.fromDate,t.toDate,t.highlightSlots)})},startdate:s,enddate:i,testHighlight:o,submitHandler:function(t){c.submitButton.on("click",n),c.submitButton.click(function(){var e=$(this).attr("data-action");t(e)})},getDetails:function(){return m.name=c.name.val().trim(),m.message=c.message.val().trim(),m.telMessage=c.teleMessage.val().trim(),m},validate:function(){if(!c.name.val().trim())return console.log("fail"),c.name.next(".error").text(errorResponses.missingName),d(c.name),!1;if(!c.message.val().trim())return c.message.next(".error").text(errorResponses.missingMessage),c.message.addClass("error-border"),d(c.message),!1;if(!c.teleMessage.val().trim())return c.teleMessage.next(".error").text(errorResponses.missingTeleMessage),c.teleMessage.addClass("error-border"),d(c.teleMessage),!1;if(1==$("#radio-button-end").is(":checked")&&""==$("#end_date").val())return c.radioInput.next(".error").text(errorResponses.missingDate),!1;if(0==parseInt(c.breakStart.val(),10)&&0<parseInt(c.breakEnd.val(),10))return c.breakhours.find(".error").text(errorResponses.missingStart),$("html, body").animate({scrollTop:c.breakhours.offset().top},200),!1;if(0==parseInt(c.breakEnd.val(),10)&&0<parseInt(c.breakStart.val(),10))return c.breakhours.find(".error").text(errorResponses.missingEnd),$("html, body").animate({scrollTop:c.breakhours.offset().top},200),!1;var e=$("#start_date").datepicker().val(),t=$("#end_date").datepicker().val();if(e=moment(e),(t=moment(t)).isBefore(e))return c.radioInput.next(".error").text("End date can not be less than the current date"),$("html, body").animate({scrollTop:c.radioInput.offset().top},200),!1;c.breakStart.val();var n,a=c.breakEnd.val();return a||(a="0"),0<(n=0,$.each(c.dayId,function(){var e=$(this).attr("id"),t=$("#"+e).find(c.start_time).val(),a=$("#"+e).find(c.end_time).val(),r=$("#"+e).find(c.checkbox).is(":checked");0==parseInt(t,10)&&0==parseInt(a,10)&&1==r&&($("#"+e).find(".error-slot").text(errorResponses.missingvalues),$("html, body").animate({scrollTop:c.slots.closest(".second-container").offset().top},200),n++)}),n)?(console.log("false"),!1):0<m.slots.length?!l():(c.slots.find(".error").text(errorResponses.missingslots),$("html, body").animate({scrollTop:c.slots.closest(".second-container").offset().top},200),!1)},setDetails:function(e){c.name.val(e.name),c.message.val(e.message,/\(\d+-\d+ \w+\)$/),c.teleMessage.val(e.telMessage,/\(\d+-\d+ \w+\)$/),m.CalendarId=e.id,m.slots=e.slots,e.breakHours.from&&c.breakStart.val(e.breakHours.from),f("breaks"),e.breakHours.to&&c.breakEnd.val(e.breakHours.to),p("breaks"),function(e){for(var t=0;t<e.length;t++){var a=e[t].day,r=e[t].slotId,n=e[t].id,o=e[t].time.from,s=e[t].time.to,i=$("#"+a).find(c.start_time).val();$("#"+a).find(c.end_time).val(),$("#"+a).css("opacity","1"),$("#"+a).attr("slotId",r),$("#"+a).find(".day").attr("id",n),0==i&&$("#"+a).find(c.start_time).val(o),$("#"+a).find(c.end_time).val(s),$("#"+a).find(c.checkbox).prop("checked","checked"),f(a),p(a)}}(e.slots);var t=e.date.from;startDate=moment(t).format("DD-MM-YYYY");var a=e.date.to;endDate=moment(a).format("DD-MM-YYYY"),$("#startdatepicker").datepicker().datepicker("setDate",startDate),$("#radio-button-startend").prop("checked",!0),"Invalid date"!=endDate&&($("#enddatepicker").datepicker().datepicker("setDate",endDate),$("#radio-button-end").prop("checked",!0)),c.submitButton.text("Update Calendar").attr("data-action","update")},Timer:r,copyTime:a,slotsCheck:l}}
