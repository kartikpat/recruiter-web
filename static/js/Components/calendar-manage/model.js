...
//     calendarRow.find(".calendar-date").text(moment(aRow.timestamp).format('MMMM DD,YYYY'));
//     calendarRow.find(".calendar-wrap").text(aRow.name);
//     calendarRow.find(".total-slots").text(aRow.nonBooked);
