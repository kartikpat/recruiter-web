...
function onBoarding(){
    ...
    function connect(){
        ...
        settings.linkedinConnect.on('click',function(){
            window.open('/auth/linkedin?page=/dashboardview&popup=yes','','scrollbars=yes,menubar=no,width=500,height=500, resizable=yes,toolbar=no,location=no,status=no')
        })

        settings.twitterConnect.on('click',function(){
            window.open('/auth/twitter?page=/dashboardview&popup=yes','',' scrollbars=yes,menubar=no,width=500,height=500, resizable=yes,toolbar=no,location=no,status=no')
        })
    }
